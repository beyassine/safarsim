    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <p>اختر حجم البيانات ومدة الصلاحية المناسبين لإقامتك في فرنسا.</p>
        </div>
...
export default {
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = document.querySelector('#europe-plans h2')?.textContent.trim() || 'SafarSim eSIM فرنسا'
    },
  },
