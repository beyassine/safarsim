      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>ابقَ متصلاً في</span><em>المملكة العربية السعودية</em></h1>
            <p>استعد لرحلة الحج أو العمرة بشريحة eSIM مسبقة الدفع. ابقَ متصلاً في مكة المكرمة والمدينة المنورة وجدة وفي أنحاء المملكة دون تغيير شريحتك الأساسية.</p>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <p>اختر حجم البيانات ومدة الصلاحية المناسبين لإقامتك في المملكة العربية السعودية.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        ...
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>تبدأ الصلاحية عند الاتصال</b><small>تبدأ الباقة عند أول اتصال بشبكة مدعومة في المملكة العربية السعودية.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>تغطية داخل المملكة العربية السعودية</b><small>استخدم الشريحة نفسها أثناء التنقل بين المناطق المشمولة.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>شبكات الهاتف والتغطية في المملكة العربية السعودية</h2>
          <p>تتصل شريحة المملكة العربية السعودية بالمشغلين الشركاء المدعومين عبر 4G/LTE و5G حيثما كانت متاحة محلياً.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="الشبكات الشريكة في المملكة العربية السعودية">
        ...
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>أبقِ تجوال البيانات مفعّلاً للشريحة أثناء تنقلك داخل المملكة العربية السعودية.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        ...
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-mosque</v-icon><div><b>الحج في مكة المكرمة</b><p>استخدم الخرائط والتطبيقات الرسمية والمراسلة طوال رحلتك المباركة.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-star-crescent</v-icon><div><b>العمرة في مكة والمدينة</b><p>ابقَ متصلاً بين الحرمين لخدمات النقل والحجوزات والتواصل مع الأهل.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-airplane</v-icon><div><b>الوصول عبر جدة</b><p>استخدم الإنترنت فور الوصول للتنقل إلى الفندق وإدارة حجوزاتك.</p></div></div>
    ...
    <section class="europe-comparison-section">
      <v-container class="europe-comparison-container">
        <div class="europe-section-heading compact">
          ...
          <h2>شريحة eSIM لالمملكة العربية السعودية أم التجوال الدولي؟</h2>
          <p>قارن بين شريحة المملكة العربية السعودية مسبقة الدفع وخدمة التجوال الدولي من مشغلك.</p>
        </div>
        <div class="comparison-table-wrap">
          <table class="comparison-table">
            <thead>
              <tr><th></th><th>eSIM المملكة العربية السعودية</th><th>التجوال الدولي</th></tr>
            </thead>
            <tbody>
        ...
        <div class="comparison-recommendation">
          ...
          <p>اختر شريحة المملكة العربية السعودية للحصول على بيانات مسبقة الدفع بحجم معروف قبل السفر. تحقق من شروط التجوال لدى مشغلك قبل مقارنة التكلفة.</p>
        </div>
    ...
    <section class="europe-installation-section">
      <v-container class="europe-installation-container">
        ...
        <ol class="europe-installation-steps">
          <li><i>1</i><span>اختر باقة المملكة العربية السعودية.</span></li>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>فعّلها في وجهتك</b><p>بعد الوصول إلى المملكة العربية السعودية، شغّل SafarSIM واختره للبيانات ثم فعّل تجوال البيانات.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>لماذا تختار SafarSim لشريحة eSIM المملكة العربية السعودية؟</h2>
          <p>تقدم SafarSim طريقة رقمية بسيطة لشراء واستخدام بيانات الهاتف في المملكة العربية السعودية.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>شراء عبر الإنترنت</b><p>اختر واشترِ باقة بيانات المملكة العربية السعودية عبر الإنترنت.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>تغطية داخل المملكة العربية السعودية</b><p>استخدم الشريحة نفسها في المناطق المشمولة داخل المملكة العربية السعودية.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>الأسئلة الشائعة حول eSIM المملكة العربية السعودية</h2>
          <p>إجابات عملية تساعدك على تجهيز شريحة المملكة العربية السعودية واستخدامها بصورة صحيحة.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>هل تعمل الشريحة في جميع أنحاء المملكة العربية السعودية؟</span><v-icon>mdi-plus</v-icon></summary><p>تتصل بالشبكات الشريكة المدعومة حيث تتوفر تغطية متوافقة داخل المملكة العربية السعودية.</p></details>
          ...
          <details><summary><span>هل تعمل أثناء التنقل داخل المملكة العربية السعودية؟</span><v-icon>mdi-plus</v-icon></summary><p>تبقى الشريحة نفسها مثبتة وتختار شبكة مدعومة متاحة تلقائياً.</p></details>
          <details><summary><span>هل يمكن تعبئة شريحة المملكة العربية السعودية؟</span><v-icon>mdi-plus</v-icon></summary><p>تعتمد التعبئة على الباقة. إذا لم تتوفر، اشترِ باقة جديدة.</p></details>
...
export default {
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = document.querySelector('#europe-plans h2')?.textContent.trim() || 'SafarSim eSIM المملكة العربية السعودية'
    },
  },
