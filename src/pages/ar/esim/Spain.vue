  ...
  <div class="europe-page" dir="rtl">
      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            ...
            <p class="europe-hero-description">سافر في أنحاء إسبانيا باستخدام شريحة eSIM واحدة مسبقة الدفع. ابقَ متصلاً في مدريد وبرشلونة وإشبيلية وغيرها دون تغيير شريحتك الفعلية.</p>
    ...
    <section class="destination-benefits-strip">
      <v-container class="destination-proof-grid">
        ...
        <div class="destination-proof-item"><v-icon size="26" aria-hidden="true">mdi-signal</v-icon><b>شبكات محلية</b></div>
      </v-container>
    </section>
...
export default {
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = destinationTitle("إسبانيا", "ar")
    },
  },
  ...
  mounted() {
    ...
    this.restoreMetadata = applyPageMetadata({
      title: destinationTitle("إسبانيا", "ar"),
