  ...
  <div class="europe-page" dir="rtl">
      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>ابقَ متصلاً في جميع أنحاء</span><em>إسبانيا</em></h1>
            <p>سافر في أنحاء إسبانيا باستخدام شريحة eSIM واحدة مسبقة الدفع. ابقَ متصلاً في مدريد وبرشلونة وإشبيلية وغيرها دون تغيير شريحتك الفعلية.</p>
            <div class="europe-actions">
              <v-btn color="#d91c58" rounded="pill" size="x-large" elevation="0" class="europe-primary" @click="scrollEuropePlans">
                عرض باقات إسبانيا<v-icon end>mdi-arrow-down</v-icon>
              </v-btn>
            </div>
          </div>
          <div class="europe-visual">
            <div class="europe-map-card">
              <img :src="spainHeroImage" alt="إسبانيا landmarks with eSIM connectivity">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <h2>اختر باقة eSIM لإسبانيا</h2>
          <p>اختر حجم البيانات ومدة الصلاحية المناسبين لإقامتك في إسبانيا.</p>
        </div>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <h2>أكمل طلبك</h2>
          <p>راجع باقة إسبانيا، ثم أدخل معلومات الاستلام والدفع الآمن.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>شرح شريحة إسبانيا</span>
          <h2>ما هي شريحة eSIM لإسبانيا؟</h2>
          <p>شريحة eSIM لإسبانيا هي شريحة رقمية تتيح استخدام بيانات الهاتف في إسبانيا دون إدخال أو استلام شريحة فعلية.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>تبدأ الصلاحية عند الاتصال</b><small>تبدأ الباقة عند أول اتصال بشبكة مدعومة في إسبانيا.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>تغطية داخل إسبانيا</b><small>استخدم الشريحة نفسها أثناء التنقل بين المناطق المشمولة.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>شبكات الهاتف والتغطية في إسبانيا</h2>
          <p>تتصل شريحة إسبانيا بالمشغلين الشركاء المدعومين عبر 4G/LTE و5G حيثما كانت متاحة محلياً.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="الشبكات الشريكة في إسبانيا">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>الدولة</th><th>الشبكات الشريكة</th></tr></thead>
            <tbody>
              <tr><th>🇪🇸 إسبانيا</th><td><span class="network-operators">Orange (Spain)<br>Telefónica Móviles (Movistar)<br>Vodafone Spain</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>أبقِ تجوال البيانات مفعّلاً للشريحة أثناء تنقلك داخل إسبانيا.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>لأي رحلات تختار شريحة eSIM لإسبانيا؟</h2>
          <p>تناسب شريحة إسبانيا العطلات وزيارات المدن ورحلات العمل والجولات داخل البلاد.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>زيارة مدريد أو برشلونة</b><p>استخدم الخرائط والمراسلة والحجوزات طوال إقامتك.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-beach</v-icon><div><b>ساحل البحر المتوسط</b><p>ابقَ متصلاً في برشلونة وفالنسيا والوجهات القريبة.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-image-filter-hdr</v-icon><div><b>الأندلس وجنوب إسبانيا</b><p>حافظ على البيانات للنقل والحجوزات.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-map-marker-path</v-icon><div><b>رحلة بين عدة مدن</b><p>استخدم شريحة واحدة أثناء التنقل بين المدن الإسبانية.</p></div></div>
    ...
    <section class="europe-comparison-section">
      <v-container class="europe-comparison-container">
        <div class="europe-section-heading compact">
          ...
          <h2>شريحة eSIM لإسبانيا أم التجوال الدولي؟</h2>
          <p>قارن بين شريحة إسبانيا مسبقة الدفع وخدمة التجوال الدولي من مشغلك.</p>
        </div>
        <div class="comparison-table-wrap">
          <table class="comparison-table">
            <thead>
              <tr><th></th><th>eSIM إسبانيا</th><th>التجوال الدولي</th></tr>
            </thead>
            <tbody>
        ...
        <div class="comparison-recommendation">
          ...
          <p>اختر شريحة إسبانيا للحصول على بيانات مسبقة الدفع بحجم معروف قبل السفر. تحقق من شروط التجوال لدى مشغلك قبل مقارنة التكلفة.</p>
        </div>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        <div class="europe-section-heading compact"><span>ثبّتها الآن واتصل عند الوصول</span><h2>متى تثبّت وتفعّل شريحة eSIM لإسبانيا؟</h2><p>يمكنك تثبيت الشريحة قبل السفر. تبدأ جميع باقات SafarSIM تلقائياً عندما تتصل الشريحة لأول مرة بشبكة مدعومة مع تفعيل تجوال البيانات.</p></div>
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>فعّلها في وجهتك</b><p>بعد الوصول إلى إسبانيا، شغّل SafarSIM واختره للبيانات ثم فعّل تجوال البيانات.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>هل يعمل واتساب مع شريحة eSIM لإسبانيا؟</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>لماذا تختار SafarSim لشريحة eSIM إسبانيا؟</h2>
          <p>تقدم SafarSim طريقة رقمية بسيطة لشراء واستخدام بيانات الهاتف في إسبانيا.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>شراء عبر الإنترنت</b><p>اختر واشترِ باقة بيانات إسبانيا عبر الإنترنت.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>تغطية داخل إسبانيا</b><p>استخدم الشريحة نفسها في المناطق المشمولة داخل إسبانيا.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>الأسئلة الشائعة حول eSIM إسبانيا</h2>
          <p>إجابات عملية تساعدك على تجهيز شريحة إسبانيا واستخدامها بصورة صحيحة.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>هل تعمل الشريحة في جميع أنحاء إسبانيا؟</span><v-icon>mdi-plus</v-icon></summary><p>تتصل بالشبكات الشريكة المدعومة حيث تتوفر تغطية متوافقة داخل إسبانيا.</p></details>
          ...
          <details><summary><span>هل تعمل أثناء التنقل داخل إسبانيا؟</span><v-icon>mdi-plus</v-icon></summary><p>تبقى الشريحة نفسها مثبتة وتختار شبكة مدعومة متاحة تلقائياً.</p></details>
          <details><summary><span>هل يمكن تعبئة شريحة إسبانيا؟</span><v-icon>mdi-plus</v-icon></summary><p>تعتمد التعبئة على الباقة. إذا لم تتوفر، اشترِ باقة جديدة.</p></details>
    ...
    <section class="europe-related-section">
      <v-container class="europe-related-container">
        ...
        <div class="europe-related-grid">
          <router-link to="/ar/esim/turkiye" class="europe-related-card"><img :src="getFlagImage('TR')" alt="تركيا"><strong>eSIM تركيا</strong><v-icon>mdi-arrow-right</v-icon></router-link>
...
export default {
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = document.querySelector('#europe-plans h2')?.textContent.trim() || 'SafarSim eSIM إسبانيا'
    },
  },
