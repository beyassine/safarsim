  ...
  <div class="europe-page" dir="rtl">
        ...
        <div class="europe-hero-grid">
          ...
          <div class="europe-visual" style="--hero-bottom-trim: 4.75260%">
            <div class="europe-map-card">
              <img :src="turkeyHeroImage" alt="تركيا landmarks with eSIM connectivity">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <h2>أكمل طلبك</h2>
          <p>راجع باقة تركيا، ثم أدخل معلومات الاستلام والدفع الآمن.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>شرح شريحة تركيا</span>
          <h2>ما هي شريحة eSIM لتركيا؟</h2>
          <p>شريحة eSIM لتركيا هي شريحة رقمية تتيح استخدام بيانات الهاتف في تركيا دون إدخال أو استلام شريحة فعلية.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>تبدأ الصلاحية عند الاتصال</b><small>تبدأ الباقة عند أول اتصال بشبكة مدعومة في تركيا.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>تغطية داخل تركيا</b><small>استخدم الشريحة نفسها أثناء التنقل بين المناطق المشمولة.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>شبكات الهاتف والتغطية في تركيا</h2>
          <p>تتصل شريحة تركيا بالمشغلين الشركاء المدعومين عبر 4G/LTE و5G حيثما كانت متاحة محلياً.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="الشبكات الشريكة في تركيا">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>الدولة</th><th>الشبكات الشريكة</th></tr></thead>
            <tbody>
              <tr><th>🇹🇷 تركيا</th><td><span class="network-operators">AVEA .Iletisim Hizmetleri A.S<br>Turkcell Iletisim Hizmetleri A.S.</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>أبقِ تجوال البيانات مفعّلاً للشريحة أثناء تنقلك داخل تركيا.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>لأي رحلات تختار شريحة eSIM لتركيا؟</h2>
          <p>تناسب شريحة تركيا العطلات وزيارات المدن ورحلات العمل والجولات داخل البلاد.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>زيارة إسطنبول</b><p>استخدم الخرائط والمراسلة والحجوزات طوال إقامتك.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-beach</v-icon><div><b>ساحل البحر المتوسط</b><p>ابقَ متصلاً في أنطاليا وبودروم والوجهات القريبة.</p></div></div>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        <div class="europe-section-heading compact"><span>ثبّتها الآن واتصل عند الوصول</span><h2>متى تثبّت وتفعّل شريحة eSIM لتركيا؟</h2><p>يمكنك تثبيت الشريحة قبل السفر. تبدأ جميع باقات SafarSIM تلقائياً عندما تتصل الشريحة لأول مرة بشبكة مدعومة مع تفعيل تجوال البيانات.</p></div>
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>فعّلها في وجهتك</b><p>بعد الوصول إلى تركيا، شغّل SafarSIM واختره للبيانات ثم فعّل تجوال البيانات.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>هل يعمل واتساب مع شريحة eSIM لتركيا؟</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>لماذا تختار SafarSim لشريحة eSIM تركيا؟</h2>
          <p>تقدم SafarSim طريقة رقمية بسيطة لشراء واستخدام بيانات الهاتف في تركيا.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>شراء عبر الإنترنت</b><p>اختر واشترِ باقة بيانات تركيا عبر الإنترنت.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>تغطية داخل تركيا</b><p>استخدم الشريحة نفسها في المناطق المشمولة داخل تركيا.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>الأسئلة الشائعة حول eSIM تركيا</h2>
          <p>إجابات عملية تساعدك على تجهيز شريحة تركيا واستخدامها بصورة صحيحة.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>هل تعمل الشريحة في جميع أنحاء تركيا؟</span><v-icon>mdi-plus</v-icon></summary><p>تتصل بالشبكات الشريكة المدعومة حيث تتوفر تغطية متوافقة داخل تركيا.</p></details>
          ...
          <details><summary><span>هل تعمل أثناء التنقل داخل تركيا؟</span><v-icon>mdi-plus</v-icon></summary><p>تبقى الشريحة نفسها مثبتة وتختار شبكة مدعومة متاحة تلقائياً.</p></details>
          <details><summary><span>هل يمكن تعبئة شريحة تركيا؟</span><v-icon>mdi-plus</v-icon></summary><p>تعتمد التعبئة على الباقة. إذا لم تتوفر، اشترِ باقة جديدة.</p></details>
...
export default {
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = destinationTitle("تركيا", "ar")
    },
  },
  ...
  mounted() {
    ...
    this.restoreMetadata = applyPageMetadata({
      title: destinationTitle("تركيا", "ar"),
