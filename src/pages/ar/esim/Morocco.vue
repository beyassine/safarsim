  ...
  <div class="europe-page" dir="rtl">
    <section class="europe-hero">
      ...
      <v-container class="europe-hero-inner">
        <div class="europe-breadcrumb">
          ...
          <strong>المغرب</strong>
        </div>
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>ابقَ متصلاً في جميع أنحاء</span><em>المغرب</em></h1>
            <p class="europe-hero-description">سافر في أنحاء المغرب باستخدام شريحة eSIM واحدة مسبقة الدفع. ابقَ متصلاً في مراكش والدار البيضاء والرباط وغيرها دون تغيير شريحتك الفعلية.</p>
            <div class="europe-actions">
              <v-btn color="#d91c58" rounded="pill" size="x-large" elevation="0" class="europe-primary" @click="scrollEuropePlans">
                عرض باقات المغرب<v-icon end>mdi-arrow-down</v-icon>
              </v-btn>
            </div>
          ...
          <div class="europe-visual" style="--hero-bottom-trim: 0%">
            <div class="europe-map-card" style="aspect-ratio: 8 / 5; overflow: hidden; display: block; margin-bottom: 0">
              <img width="1536" height="1024" fetchpriority="high" :src="moroccoHeroImage" alt="معالم المغرب والاتصال عبر eSIM">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section class="morocco-proof-strip">
      <v-container class="morocco-proof-grid">
        <div><b>ابتداءً من {{ startingPrice }}</b><span>باقات مسبقة الدفع للمغرب</span></div>
        <div><b>قبل السفر</b><span>ثبّت شريحتك مسبقاً</span></div>
        <div><b>عند الوصول</b><span>اتصل بالإنترنت في المغرب</span></div>
        <div><b>Orange Maroc · Maroc Telecom</b><span>شبكات محلية شريكة</span></div>
      </v-container>
    </section>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <h2>اختر باقة eSIM للمغرب</h2>
          <p>اختر حجم البيانات ومدة الصلاحية المناسبين لإقامتك في المغرب.</p>
        </div>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <h2>أكمل طلبك</h2>
          <p>راجع باقة المغرب، ثم أدخل معلومات الاستلام والدفع الآمن.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>شرح شريحة المغرب</span>
          <h2>ما هي شريحة eSIM للمغرب؟</h2>
          <p>شريحة eSIM للمغرب هي شريحة رقمية تتيح استخدام بيانات الهاتف في المغرب دون إدخال أو استلام شريحة فعلية.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-access-point</v-icon><span><b>مشاركة الاتصال</b><small>تدعم معظم الباقات نقطة الاتصال حسب الجهاز والشبكة.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>تبدأ الصلاحية عند الاتصال</b><small>تبدأ الباقة عند أول اتصال بشبكة مدعومة في المغرب.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>تغطية داخل المغرب</b><small>استخدم الشريحة نفسها أثناء التنقل بين المناطق المشمولة.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>شبكات الهاتف والتغطية في المغرب</h2>
          <p>تتصل شريحة المغرب بالمشغلين الشركاء المدعومين عبر 4G/LTE حسب التغطية المحلية.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="الشبكات الشريكة في المغرب">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>الدولة</th><th>الشبكات الشريكة</th></tr></thead>
            <tbody>
              <tr><th>🇲🇦 المغرب</th><td><span class="network-operators">Orange Maroc<br>Maroc Telecom</span><span class="technology-badge">4G / LTE</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>أبقِ تجوال البيانات مفعّلاً للشريحة أثناء تنقلك داخل المغرب.</span>
        </div>
        <p class="network-disclaimer">يعتمد توفر الشبكة والسرعة على التغطية المحلية وحالة الشبكة وتوافق جهازك.</p>
      </v-container>
    </section>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>لأي رحلات تختار شريحة eSIM للمغرب؟</h2>
          <p>تناسب شريحة المغرب العطلات وزيارات المدن ورحلات العمل والجولات داخل البلاد.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>زيارة مراكش</b><p>استخدم الخرائط والمراسلة والحجوزات طوال إقامتك.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-beach</v-icon><div><b>ساحل المحيط الأطلسي</b><p>ابقَ متصلاً في أكادير والصويرة والوجهات القريبة.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-image-filter-hdr</v-icon><div><b>فاس والمدن العتيقة</b><p>حافظ على البيانات للنقل والحجوزات.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-map-marker-path</v-icon><div><b>رحلة بين عدة مدن</b><p>استخدم شريحة واحدة أثناء التنقل بين المدن المغربية.</p></div></div>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        <div class="europe-section-heading compact"><span>ثبّتها الآن واتصل عند الوصول</span><h2>متى تثبّت وتفعّل شريحة eSIM للمغرب؟</h2><p>يمكنك تثبيت الشريحة قبل السفر. تبدأ جميع باقات SafarSIM تلقائياً عندما تتصل الشريحة لأول مرة بشبكة مدعومة مع تفعيل تجوال البيانات.</p></div>
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>فعّلها في وجهتك</b><p>بعد الوصول إلى المغرب، شغّل SafarSIM واختره للبيانات ثم فعّل تجوال البيانات.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>هل يعمل واتساب مع شريحة eSIM للمغرب؟</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>لماذا تختار SafarSim لشريحة eSIM المغرب؟</h2>
          <p>تقدم SafarSim طريقة رقمية بسيطة لشراء واستخدام بيانات الهاتف في المغرب.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>شراء عبر الإنترنت</b><p>اختر واشترِ باقة بيانات المغرب عبر الإنترنت.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>تغطية داخل المغرب</b><p>استخدم الشريحة نفسها في المناطق المشمولة داخل المغرب.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>الأسئلة الشائعة حول eSIM المغرب</h2>
          <p>إجابات عملية تساعدك على تجهيز شريحة المغرب واستخدامها بصورة صحيحة.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>هل تعمل الشريحة في جميع أنحاء المغرب؟</span><v-icon>mdi-plus</v-icon></summary><p>تتصل بالشبكات الشريكة المدعومة حيث تتوفر تغطية متوافقة داخل المغرب.</p></details>
          <details><summary><span>هل يمكنني تثبيتها قبل السفر؟</span><v-icon>mdi-plus</v-icon></summary><p>نعم. ثبّتها قبل المغادرة باستخدام Wi-Fi مستقر.</p></details>
          <details><summary><span>متى تبدأ الصلاحية؟</span><v-icon>mdi-plus</v-icon></summary><p>تبدأ عند أول اتصال بشبكة مدعومة مع تشغيل تجوال البيانات.</p></details>
          <details><summary><span>هل يمكنني استخدام واتساب برقمي المعتاد؟</span><v-icon>mdi-plus</v-icon></summary><p>نعم. توفر SafarSim البيانات دون تغيير الرقم المسجل في واتساب.</p></details>
          <details><summary><span>هل مشاركة الاتصال متاحة؟</span><v-icon>mdi-plus</v-icon></summary><p>تدعم معظم الباقات نقطة الاتصال حسب الجهاز والشبكة المحلية.</p></details>
          <details><summary><span>ما تقنية الاتصال المدعومة؟</span><v-icon>mdi-plus</v-icon></summary><p>تدعم باقات المغرب تقنية 4G/LTE على الشبكات الشريكة المتوافقة. يعتمد توفر الخدمة وسرعتها على موقعك وجهازك.</p></details>
          <details><summary><span>هل يمكنني الاحتفاظ بشريحتي الحالية؟</span><v-icon>mdi-plus</v-icon></summary><p>نعم على هاتف يدعم شريحتين. احتفظ بشريحتك واختر SafarSim للبيانات.</p></details>
          <details><summary><span>هل تعمل أثناء التنقل داخل المغرب؟</span><v-icon>mdi-plus</v-icon></summary><p>تبقى الشريحة نفسها مثبتة وتختار شبكة مدعومة متاحة تلقائياً.</p></details>
          <details><summary><span>هل يمكن تعبئة شريحة المغرب؟</span><v-icon>mdi-plus</v-icon></summary><p>تعتمد التعبئة على الباقة. إذا لم تتوفر، اشترِ باقة جديدة.</p></details>
          <details><summary><span>ما الهواتف المتوافقة؟</span><v-icon>mdi-plus</v-icon></summary><p>تدعم أجهزة حديثة عديدة من Apple وSamsung وGoogle وغيرها eSIM. تحقق من طرازك قبل الشراء.</p></details>
        </div>
      </v-container>
    </section>
    ...
    <div class="europe-last-updated">
      <v-container><v-icon size="17">mdi-calendar-check-outline</v-icon><span>تم تحديث المعلومات في 11 سبتمبر 2026.</span></v-container>
    </div>
    ...
    updateStructuredData() {
      ...
      const schema = [
        ...
        },
        {
          ...
          category: 'Travel eSIM', image: new URL(moroccoHeroImage, 'https://safarsim.net').href,
          offers: this.sortedPlans.map((plan) => ({
            '@type': 'Offer', name: `${plan.dataLabel} · ${plan.days} أيام`,
  ...
  mounted() {
    this.$nextTick(() => {
      ...
      this.restoreMetadata = applyPageMetadata({
        title: "eSIM المغرب | باقات إنترنت مسبقة الدفع للسفر | SafarSIM",
        description: "سافر إلى المغرب مع شريحة SafarSIM مسبقة الدفع. قارن باقات الإنترنت وتعرّف على التغطية وثبّت شريحتك قبل السفر مع الاحتفاظ برقم واتساب المعتاد.",
...
/* Arabic layout: keep each icon on the reading side and prevent mixed-direction
   labels, arrows, and Latin network names from collapsing spacing. */
.europe-page[dir="rtl"] .europe-fact,
.europe-page[dir="rtl"] .europe-use-case-card,
.europe-page[dir="rtl"] .safarsim-fact-card,
.europe-page[dir="rtl"] .activation-guidance>div{flex-direction:row-reverse;text-align:right}
...
.europe-page[dir="rtl"] .activation-guidance>div>span{min-width:0;flex:1}
...
.europe-page[dir="rtl"] .activation-guidance>div>.v-icon{flex:0 0 auto}
...
.europe-page[dir="rtl"] .network-table th,
.europe-page[dir="rtl"] .network-table td,
.europe-page[dir="rtl"] .comparison-table th,
.europe-page[dir="rtl"] .comparison-table td{text-align:right}
...
.europe-page[dir="rtl"] .europe-installation-steps li,
.europe-page[dir="rtl"] .europe-guide-links a,
.europe-page[dir="rtl"] .comparison-links a{direction:rtl}
.europe-page[dir="rtl"] .europe-guide-links a .v-icon:last-child,
.europe-page[dir="rtl"] .comparison-links a>.v-icon{transform:scaleX(-1)}
