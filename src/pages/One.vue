    ...
    <section class="hero-section">
      ...
      <v-container fluid class="hero-container">
        ...
        <div class="hero-visual" :aria-label="c.connected">
          ...
          <div class="floating-card activation-card"><v-icon>mdi-clock-fast</v-icon><span><b>{{ c.instant }}</b></span></div>
        </div>
      </v-container>
    </section>
...
}[locale.value] || 'Votre forfait en quelques étapes simples'))
const catalogCopy = {
...
.purchase-card { max-width:1180px;margin:auto;display:grid;grid-template-columns:440px 1fr;gap:24px;align-items:start;background:transparent; }.purchase-card--single{grid-template-columns:minmax(0,620px);justify-content:center}
.destination-panel,.package-panel{background:#fff;border:1px solid #eee2dc;border-radius:24px;box-shadow:0 16px 42px rgba(80,42,60,.07)}.destination-panel { padding:32px;scroll-margin-top:78px }.package-panel{padding:28px 32px;scroll-margin-top:78px}.step-label{display:flex;align-items:center;gap:10px;font-size:18px;font-weight:800;margin-bottom:20px}.step-label i{width:31px;height:31px;display:grid;place-items:center;border-radius:50%;background:var(--green);color:#fff;font-style:normal;font-size:14px}.step-label small{margin-inline-start:auto;color:#806572;font-size:12px;font-weight:700;background:#fffbf8;padding:5px 9px;border-radius:99px}
...
.search-wrap { height:58px;background:#fff;border:1px solid #d8e3df;border-radius:14px;padding:0 16px;display:flex;align-items:center;gap:10px;margin-bottom:16px;color:#83928e;font-size:16px}.search-wrap .v-icon{font-size:24px!important}.search-wrap input{border:0;outline:0;background:transparent;width:100%;font:inherit;color:var(--ink)}
