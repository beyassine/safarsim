  ...
  <div class="europe-page" dir="ltr">
    ...
    <section class="europe-proof-strip">
      <v-container class="europe-proof-grid">
        <div class="proof-highlight"><v-icon>mdi-map-marker-multiple-outline</v-icon><b><strong>38</strong> covered countries</b></div>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <h2>Choose your Europe eSIM plan</h2>
          <p>Pay once, stay connected across all included countries, and use your data until the plan expires.</p>
        </div>
        ...
        <details class="covered-countries-compact">
          <summary><v-icon>mdi-map-marker-multiple-outline</v-icon><strong>38 covered countries</strong><v-icon class="covered-toggle">mdi-chevron-down</v-icon></summary>
          <div class="covered-country-chips">
            <router-link to="/esim/autriche"><img :src="getFlagImage('AT')" alt="Austria"><span>Austria</span></router-link>
            <router-link to="/esim/danemark"><img :src="getFlagImage('DK')" alt="Denmark"><span>Denmark</span></router-link>
            <router-link to="/esim/irlande"><img :src="getFlagImage('IE')" alt="Ireland"><span>Ireland</span></router-link>
            <router-link to="/esim/italie"><img :src="getFlagImage('IT')" alt="Italy"><span>Italy</span></router-link>
            <router-link to="/esim/suede"><img :src="getFlagImage('SE')" alt="Sweden"><span>Sweden</span></router-link>
            <router-link to="/esim/france"><img :src="getFlagImage('FR')" alt="France"><span>France</span></router-link>
            <router-link to="/esim/bulgarie"><img :src="getFlagImage('BG')" alt="Bulgaria"><span>Bulgaria</span></router-link>
            <router-link to="/esim/chypre"><img :src="getFlagImage('CY')" alt="Cyprus"><span>Cyprus</span></router-link>
            <router-link to="/esim/estonie"><img :src="getFlagImage('EE')" alt="Estonia"><span>Estonia</span></router-link>
            <router-link to="/esim/finlande"><img :src="getFlagImage('FI')" alt="Finland"><span>Finland</span></router-link>
            <router-link to="/esim/grece"><img :src="getFlagImage('GR')" alt="Greece"><span>Greece</span></router-link>
            <router-link to="/esim/hongrie"><img :src="getFlagImage('HU')" alt="Hungary"><span>Hungary</span></router-link>
            <router-link to="/esim/lettonie"><img :src="getFlagImage('LV')" alt="Latvia"><span>Latvia</span></router-link>
            <router-link to="/esim/lituanie"><img :src="getFlagImage('LT')" alt="Lithuania"><span>Lithuania</span></router-link>
            <router-link to="/esim/pays-bas"><img :src="getFlagImage('NL')" alt="Netherlands"><span>Netherlands</span></router-link>
            <router-link to="/esim/norvege"><img :src="getFlagImage('NO')" alt="Norway"><span>Norway</span></router-link>
            <router-link to="/esim/pologne"><img :src="getFlagImage('PL')" alt="Poland"><span>Poland</span></router-link>
            <router-link to="/esim/roumanie"><img :src="getFlagImage('RO')" alt="Romania"><span>Romania</span></router-link>
            <router-link to="/esim/slovaquie"><img :src="getFlagImage('SK')" alt="Slovakia"><span>Slovakia</span></router-link>
            <router-link to="/esim/spain"><img :src="getFlagImage('ES')" alt="Spain"><span>Spain</span></router-link>
            <router-link to="/esim/royaume-uni"><img :src="getFlagImage('GB')" alt="United Kingdom"><span>United Kingdom</span></router-link>
            <router-link to="/esim/turkiye"><img :src="getFlagImage('TR')" alt="Türkiye"><span>Türkiye</span></router-link>
            <router-link to="/esim/allemagne"><img :src="getFlagImage('DE')" alt="Germany"><span>Germany</span></router-link>
            <router-link to="/esim/malte"><img :src="getFlagImage('MT')" alt="Malta"><span>Malta</span></router-link>
            <router-link to="/esim/suisse"><img :src="getFlagImage('CH')" alt="Switzerland"><span>Switzerland</span></router-link>
            <router-link to="/esim/belgique"><img :src="getFlagImage('BE')" alt="Belgium"><span>Belgium</span></router-link>
            <router-link to="/esim/croatie"><img :src="getFlagImage('HR')" alt="Croatia"><span>Croatia</span></router-link>
            <router-link to="/esim/republique-tcheque"><img :src="getFlagImage('CZ')" alt="Czechia"><span>Czechia</span></router-link>
            <router-link to="/esim/liechtenstein"><img :src="getFlagImage('LI')" alt="Liechtenstein"><span>Liechtenstein</span></router-link>
            <router-link to="/esim/luxembourg"><img :src="getFlagImage('LU')" alt="Luxembourg"><span>Luxembourg</span></router-link>
            <router-link to="/esim/portugal"><img :src="getFlagImage('PT')" alt="Portugal"><span>Portugal</span></router-link>
            <router-link to="/esim/slovenie"><img :src="getFlagImage('SI')" alt="Slovenia"><span>Slovenia</span></router-link>
            <router-link to="/esim/islande"><img :src="getFlagImage('IS')" alt="Iceland"><span>Iceland</span></router-link>
            <router-link to="/esim/iles-canaries"><img :src="getFlagImage('IC')" alt="Canary Islands"><span>Canary Islands</span></router-link>
            <router-link to="/esim/cite-du-vatican"><img :src="getFlagImage('VA')" alt="Vatican City"><span>Vatican City</span></router-link>
            <router-link to="/esim/cyp"><img :src="getFlagImage('CYP')" alt="Cyprus"><span>Cyprus</span></router-link>
            <router-link to="/esim/moldavie"><img :src="getFlagImage('MD')" alt="Moldova"><span>Moldova</span></router-link>
            <router-link to="/esim/serbie"><img :src="getFlagImage('RS')" alt="Serbia"><span>Serbia</span></router-link>
          </div>
        </details>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Mobile networks and coverage in Europe</h2>
          <p>Your Europe eSIM connects to supported partner operators across the included countries, with 4G/LTE and 5G where locally available.</p>
        </div>
        <details class="network-disclosure">
          <summary><span>View all partner networks</span><v-icon>mdi-chevron-down</v-icon></summary>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Who should choose a Europe eSIM?</h2>
          <p>A Europe eSIM is particularly useful when you visit several countries during the same trip.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-map-marker-path</v-icon><div><b>Spain + Portugal</b><p>Stay connected throughout an Iberian itinerary without changing SIMs.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-train</v-icon><div><b>France + Belgium + Netherlands</b><p>Use the same data plan while travelling between three neighbouring countries.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-image-filter-hdr</v-icon><div><b>Italy + Switzerland</b><p>Keep maps, bookings and messages available on both sides of the border.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>Multi-city European trips</b><p>Ideal for holidays that combine several cities and countries.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-briefcase-outline</v-icon><div><b>Business travel across Europe</b><p>Maintain one reliable connection for meetings, transport and work apps.</p></div></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-comparison-section">
      <v-container class="europe-comparison-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Europe eSIM or single-country eSIM?</h2>
          <p>The best option depends mainly on how many countries you plan to visit.</p>
        </div>
        <div class="comparison-table-wrap">
          <table class="comparison-table">
            <thead>
              <tr><th></th><th>Europe eSIM</th><th>Country eSIM</th></tr>
            </thead>
            <tbody>
        ...
        <div class="comparison-recommendation">
          ...
          <p>If you are travelling only in Spain for one week, a Spain eSIM may be more suitable. If your trip includes Spain, Portugal and France, a Europe plan is generally more convenient.</p>
        </div>
    ...
    <section class="europe-installation-section">
      <v-container class="europe-installation-container">
        <div class="europe-section-heading compact">
          ...
          <h2>How to install your Europe eSIM</h2>
        ...
        <ol class="europe-installation-steps">
          <li><i>1</i><span>Choose your Europe plan.</span></li>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activate at your destination</b><p>After arriving in Europe, enable SafarSIM, select it for mobile data and turn on data roaming.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>Does WhatsApp work with a Europe eSIM?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Why choose SafarSim for your Europe eSIM?</h2>
          <p>SafarSim provides a straightforward digital way to purchase and use mobile data across multiple European countries.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Online purchase</b><p>Choose and purchase your Europe data plan online.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Multi-country coverage</b><p>Use the same Europe eSIM throughout the included countries.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Europe eSIM FAQ</h2>
          <p>Practical answers to help you prepare and use your Europe eSIM correctly.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>Does one eSIM work in several European countries?</span><v-icon>mdi-plus</v-icon></summary><p>Yes. The same Europe eSIM works across all countries included in the plan, without replacing the eSIM at each border.</p></details>
          <details><summary><span>Can I install the eSIM before travelling?</span><v-icon>mdi-plus</v-icon></summary><p>Yes. Install it before departure using a stable Wi-Fi connection. The plan starts when it first connects to a supported network with data roaming enabled.</p></details>
          <details><summary><span>When does my plan validity begin?</span><v-icon>mdi-plus</v-icon></summary><p>Validity begins when the eSIM first connects to a supported network, not simply when the profile is installed.</p></details>
          <details><summary><span>Can I use WhatsApp with my usual phone number?</span><v-icon>mdi-plus</v-icon></summary><p>Yes. You can keep using WhatsApp with your usual number while the SafarSim eSIM supplies mobile data.</p></details>
          <details><summary><span>Is personal hotspot use allowed?</span><v-icon>mdi-plus</v-icon></summary><p>Most plans support personal hotspot use, subject to your device and the local partner network.</p></details>
          <details><summary><span>Is 5G available?</span><v-icon>mdi-plus</v-icon></summary><p>5G is available where supported by the local partner network and your device. The eSIM otherwise connects using 4G/LTE.</p></details>
          <details><summary><span>Can I keep my current physical SIM?</span><v-icon>mdi-plus</v-icon></summary><p>Yes, on a dual-SIM compatible phone. Keep your current SIM for your usual number and select SafarSim as the mobile-data line.</p></details>
          <details><summary><span>What happens when I change countries?</span><v-icon>mdi-plus</v-icon></summary><p>The same eSIM connects automatically to an available partner network in the next covered country. Keep data roaming enabled on the SafarSim line.</p></details>
    ...
    <div class="europe-last-updated">
      <v-container><v-icon size="17">mdi-calendar-check-outline</v-icon><span>Information updated on 1 September 2026.</span></v-container>
    </div>
...
export default {
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = document.querySelector('#europe-plans h2')?.textContent.trim() || 'SafarSim Europe eSIM'
    },
  },
