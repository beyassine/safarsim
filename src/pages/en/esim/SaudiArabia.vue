        ...
        <div class="europe-hero-grid">
          ...
          <div class="europe-visual" style="--hero-bottom-trim: 3.25521%">
            <div class="europe-map-card">
              <img :src="saudiArabiaHeroImage" alt="Saudi Arabia landmarks with eSIM connectivity">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <h2>Choose your Saudi Arabia eSIM plan</h2>
          <p>Choose the data allowance and validity period that match your stay in Saudi Arabia.</p>
        </div>
        <div class="europe-plan-grid">
          <button v-for="plan in sortedPlans" :key="plan.key" type="button" class="europe-plan-card" :class="{ active: selectedPlanKey === plan.key }" @click="handleAddToCart(plan)">
            <span v-if="plan.data === '20GB'" class="popular-label">Most popular • Great for Hajj &amp; longer stays</span>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>Saudi Arabia eSIM explained</span>
          <h2>What is a Saudi Arabia eSIM?</h2>
          <p>A Saudi Arabia eSIM is a digital SIM that provides mobile data in Saudi Arabia without inserting or collecting a physical SIM card.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>Validity starts on connection</b><small>The plan starts when the eSIM first connects to a supported network in Saudi Arabia.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>Coverage within Saudi Arabia</b><small>Use the same eSIM while travelling between covered locations in Saudi Arabia.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Mobile networks and coverage in Saudi Arabia</h2>
          <p>Your Saudi Arabia eSIM connects to supported partner operators, with 4G/LTE and 5G where locally available.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="Partner networks in Saudi Arabia">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>Country</th><th>Partner network(s)</th></tr></thead>
            <tbody>
              <tr><th>🇸🇦 Saudi Arabia</th><td><span class="network-operators">STC<br>Mobily<br>Zain</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>Keep data roaming enabled on the eSIM while travelling within Saudi Arabia.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Who should choose a Saudi Arabia eSIM?</h2>
          <p>A Saudi Arabia eSIM is especially useful for Hajj and Umrah pilgrims, as well as holidays, business travel and longer stays.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-mosque</v-icon><div><b>Hajj in Makkah</b><p>Use maps, official pilgrimage apps and messaging throughout your sacred journey.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-star-crescent</v-icon><div><b>Umrah in Makkah and Madinah</b><p>Stay connected between the holy cities for transport, bookings and family contact.</p></div></div>
          ...
          <div class="europe-use-case-card"><v-icon>mdi-map-marker-path</v-icon><div><b>Multi-city trips</b><p>Use one eSIM while travelling between Makkah, Madinah, Jeddah and other destinations across Saudi Arabia.</p></div></div>
    ...
    <section class="europe-installation-section">
      <v-container class="europe-installation-container">
        <div class="europe-section-heading compact">
          ...
          <h2>How to install your Saudi Arabia eSIM</h2>
        ...
        <ol class="europe-installation-steps">
          <li><i>1</i><span>Choose your Saudi Arabia plan.</span></li>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activate at your destination</b><p>After arriving in Saudi Arabia, enable SafarSIM, select it for mobile data and turn on data roaming.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>Does WhatsApp work with a Saudi Arabia eSIM?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Why choose SafarSim for your Saudi Arabia eSIM?</h2>
          <p>SafarSim provides a straightforward digital way to purchase and use mobile data in Saudi Arabia.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Online purchase</b><p>Choose and purchase your Saudi Arabia data plan online.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Coverage in Saudi Arabia</b><p>Use the same eSIM throughout covered areas in Saudi Arabia.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Saudi Arabia eSIM FAQ</h2>
          <p>Practical answers to help you prepare and use your Saudi Arabia eSIM correctly.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>Does the eSIM work throughout Saudi Arabia?</span><v-icon>mdi-plus</v-icon></summary><p>It connects to supported partner networks wherever compatible coverage is available in Saudi Arabia.</p></details>
          ...
          <details><summary><span>Will it work when I travel around Saudi Arabia?</span><v-icon>mdi-plus</v-icon></summary><p>The same eSIM remains installed and selects an available supported network automatically.</p></details>
          <details><summary><span>Can I top up the Saudi Arabia eSIM?</span><v-icon>mdi-plus</v-icon></summary><p>Top-up availability depends on the selected plan. If unavailable, purchase a new plan.</p></details>
...
export default {
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = document.querySelector('#europe-plans h2')?.textContent.trim() || 'SafarSim Saudi Arabia eSIM'
    },
  },
