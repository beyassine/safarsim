      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>Stay connected throughout</span><em>Turkey</em></h1>
            <p>Travel across Turkey with one prepaid eSIM. Stay connected in Istanbul, Ankara, Antalya and beyond without changing your physical SIM.</p>
            <div class="europe-actions">
              <v-btn color="#d91c58" rounded="pill" size="x-large" elevation="0" class="europe-primary" @click="scrollEuropePlans">
                See Turkey plans<v-icon end>mdi-arrow-down</v-icon>
              </v-btn>
            </div>
          </div>
          <div class="europe-visual">
            <div class="europe-map-card">
              <img :src="turkeyHeroImage" alt="Turkey landmarks with eSIM connectivity">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <h2>Choose your Turkey eSIM plan</h2>
          <p>Choose the data allowance and validity period that match your stay in Turkey.</p>
        </div>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <p>Review your Turkey plan, then enter your delivery and secure payment details.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>Turkey eSIM explained</span>
          <h2>What is a Turkey eSIM?</h2>
          <p>A Turkey eSIM is a digital SIM that provides mobile data in Turkey without inserting or collecting a physical SIM card.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>Validity starts on connection</b><small>The plan starts when the eSIM first connects to a supported network in Turkey.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>Coverage within Turkey</b><small>Use the same eSIM while travelling between covered locations in Turkey.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Mobile networks and coverage in Turkey</h2>
          <p>Your Turkey eSIM connects to supported partner operators, with 4G/LTE and 5G where locally available.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="Partner networks in Turkey">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>Country</th><th>Partner network(s)</th></tr></thead>
            <tbody>
              <tr><th>🇹🇷 Turkey</th><td><span class="network-operators">AVEA .Iletisim Hizmetleri A.S<br>Turkcell Iletisim Hizmetleri A.S.</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>Keep data roaming enabled on the eSIM while travelling within Turkey.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Who should choose a Turkey eSIM?</h2>
          <p>A Turkey eSIM is useful for holidays, city breaks, business travel and longer stays within Turkey.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>Istanbul city break</b><p>Use maps, messaging and booking apps throughout your stay.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-beach</v-icon><div><b>Mediterranean coast</b><p>Stay connected while visiting Antalya, Bodrum or nearby destinations.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-image-filter-hdr</v-icon><div><b>Cappadocia and central Turkey</b><p>Keep mobile data available for transport and reservations.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-map-marker-path</v-icon><div><b>Multi-city trips</b><p>Use one eSIM while travelling between Turkish cities.</p></div></div>
    ...
    <section class="europe-comparison-section">
      <v-container class="europe-comparison-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Turkey eSIM or international roaming?</h2>
          <p>Compare a prepaid Turkey eSIM with using your operator’s international roaming.</p>
        </div>
        <div class="comparison-table-wrap">
          <table class="comparison-table">
            <thead>
              <tr><th></th><th>Turkey eSIM</th><th>International roaming</th></tr>
            </thead>
            <tbody>
        ...
        <div class="comparison-recommendation">
          ...
          <p>Choose a Turkey eSIM when you want prepaid mobile data and a known allowance before departure. Check your home operator’s roaming terms before comparing costs.</p>
        </div>
    ...
    <section class="europe-installation-section">
      <v-container class="europe-installation-container">
        <div class="europe-section-heading compact">
          ...
          <h2>How to install your Turkey eSIM</h2>
        ...
        <ol class="europe-installation-steps">
          <li><i>1</i><span>Choose your Turkey plan.</span></li>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activate at your destination</b><p>After arriving in Turkey, enable SafarSIM, select it for mobile data and turn on data roaming.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>Does WhatsApp work with a Turkey eSIM?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Why choose SafarSim for your Turkey eSIM?</h2>
          <p>SafarSim provides a straightforward digital way to purchase and use mobile data in Turkey.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Online purchase</b><p>Choose and purchase your Turkey data plan online.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Coverage in Turkey</b><p>Use the same eSIM throughout covered areas in Turkey.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Turkey eSIM FAQ</h2>
          <p>Practical answers to help you prepare and use your Turkey eSIM correctly.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>Does the eSIM work throughout Turkey?</span><v-icon>mdi-plus</v-icon></summary><p>It connects to supported partner networks wherever compatible coverage is available in Turkey.</p></details>
          ...
          <details><summary><span>Will it work when I travel around Turkey?</span><v-icon>mdi-plus</v-icon></summary><p>The same eSIM remains installed and selects an available supported network automatically.</p></details>
          <details><summary><span>Can I top up the Turkey eSIM?</span><v-icon>mdi-plus</v-icon></summary><p>Top-up availability depends on the selected plan. If unavailable, purchase a new plan.</p></details>
...
export default {
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = document.querySelector('#europe-plans h2')?.textContent.trim() || 'SafarSim Turkey eSIM'
    },
  },
