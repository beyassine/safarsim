      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>Stay connected throughout</span><em>France</em></h1>
            <p>Travel across France with one prepaid eSIM. Stay connected in Paris, Lyon, Marseille and beyond without changing your physical SIM.</p>
            <div class="europe-actions">
              <v-btn color="#d91c58" rounded="pill" size="x-large" elevation="0" class="europe-primary" @click="scrollEuropePlans">
                See France plans<v-icon end>mdi-arrow-down</v-icon>
              </v-btn>
            </div>
          </div>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <p>Review your France plan, then enter your delivery and secure payment details.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>France eSIM explained</span>
          <h2>What is a France eSIM?</h2>
          <p>A France eSIM is a digital SIM that provides mobile data in France without inserting or collecting a physical SIM card.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>Validity starts on connection</b><small>The plan starts when the eSIM first connects to a supported network in France.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>Coverage within France</b><small>Use the same eSIM while travelling between covered locations in France.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Mobile networks and coverage in France</h2>
          <p>Your France eSIM connects to supported partner operators, with 4G/LTE and 5G where locally available.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="Partner networks in France">
        ...
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>Keep data roaming enabled on the eSIM while travelling within France.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Who should choose a France eSIM?</h2>
          <p>A France eSIM is useful for holidays, city breaks, business travel and longer stays within France.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>Paris or Lyon city break</b><p>Use maps, messaging and booking apps throughout your stay.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-beach</v-icon><div><b>Mediterranean coast</b><p>Stay connected while visiting Marseille, Nice or nearby destinations.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-image-filter-hdr</v-icon><div><b>Provence and southern France</b><p>Keep mobile data available for transport and reservations.</p></div></div>
    ...
    <section class="europe-comparison-section">
      <v-container class="europe-comparison-container">
        <div class="europe-section-heading compact">
          ...
          <h2>France eSIM or international roaming?</h2>
          <p>Compare a prepaid France eSIM with using your operator’s international roaming.</p>
        </div>
        <div class="comparison-table-wrap">
          <table class="comparison-table">
            <thead>
              <tr><th></th><th>France eSIM</th><th>International roaming</th></tr>
            </thead>
            <tbody>
        ...
        <div class="comparison-recommendation">
          ...
          <p>Choose a France eSIM when you want prepaid mobile data and a known allowance before departure. Check your home operator’s roaming terms before comparing costs.</p>
        </div>
    ...
    <section class="europe-installation-section">
      <v-container class="europe-installation-container">
        <div class="europe-section-heading compact">
          ...
          <h2>How to install your France eSIM</h2>
        ...
        <ol class="europe-installation-steps">
          <li><i>1</i><span>Choose your France plan.</span></li>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activate at your destination</b><p>After arriving in France, enable SafarSIM, select it for mobile data and turn on data roaming.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>Does WhatsApp work with a France eSIM?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Why choose SafarSim for your France eSIM?</h2>
          <p>SafarSim provides a straightforward digital way to purchase and use mobile data in France.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Online purchase</b><p>Choose and purchase your France data plan online.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Coverage in France</b><p>Use the same eSIM throughout covered areas in France.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>France eSIM FAQ</h2>
          <p>Practical answers to help you prepare and use your France eSIM correctly.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>Does the eSIM work throughout France?</span><v-icon>mdi-plus</v-icon></summary><p>It connects to supported partner networks wherever compatible coverage is available in France.</p></details>
          ...
          <details><summary><span>Will it work when I travel around France?</span><v-icon>mdi-plus</v-icon></summary><p>The same eSIM remains installed and selects an available supported network automatically.</p></details>
          <details><summary><span>Can I top up the France eSIM?</span><v-icon>mdi-plus</v-icon></summary><p>Top-up availability depends on the selected plan. If unavailable, purchase a new plan.</p></details>
