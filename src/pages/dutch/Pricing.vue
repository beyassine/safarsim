  ...
  <div class="pricing-page">
    <v-container class="py-12 py-md-16">
      <div class="text-center mb-10">
        ...
        <h1 class="page-title">Onze eSIM-prijzen</h1>
        <p class="page-subtitle"> Eenvoudige, flexibele bundels voor je reizen, met transparante prijzen voor elke bestemming. </p>
      </div>
      ...
      <v-card class="pricing-card mb-10" elevation="0">
        <div class="pricing-header">
          <h2>Hoe werken onze prijzen?</h2>
          <p> Prijzen variëren afhankelijk van de bestemming, de hoeveelheid data en de looptijd. Bij SafarSim vind je aanbiedingen voor korte verblijven en langere reizen. </p>
        </div>

        <div class="pricing-block">
          <h3>Wat bepaalt de prijs</h3>
        ...
        <div class="pricing-note">
          <p> De onderstaande prijzen gelden voor onze beschikbare bundels op enkele populaire bestemmingen. </p>
        </div>
      </v-card>

      <div class="section-header text-center mb-6">
        <h2>Populaire bestemmingen</h2>
        <p> Bekijk enkele van onze meest gevraagde bestemmingen met hun eSIM-prijzen. </p>
      </div>
            ...
            <div class="destination-content" :class="{ 'destination-content--rtl': false }">
              <div class="destination-top">
                ...
                <div class="from-price" :class="{ 'from-price--rtl': false }">
                  <span class="from-price-label">Vanaf</span>
                  <span class="from-price-value" dir="ltr">{{ formatPriceFromMad(getEntryPrice(destination), 'nl') }}</span>
                </div>
              </div>
              ...
              <div class="plans-preview">
                ...
                >
                  ...
                  <span class="plan-value">{{ formatPriceFromMad(plan.price, 'nl') }}</span>
                </div>
              </div>
              ...
              <v-btn
                ...
                rounded="xl"
                block
                :to="`/nl/esim/${destinationUrlSlug(destination)}`"
              > Bekijk aanbod </v-btn>
            </div>
          </v-card>
        </v-col>
      ...
      <div class="text-center mt-10">
        <v-btn
          ...
          class="cta-btn"
          to="/nl/esim"
        > Bekijk alle bestemmingen </v-btn>
      </div>
    </v-container>
  </div>
</template>
...
function formatPlanLabel(key) {
  ...
  return data + " / " + duration.replace("days", " dagen")
}
...
function getDestinationName(destination) {
  return getLocalizedName(destination, 'nl')
}
