<template>
  <div class="europe-page" dir="ltr">
      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><em>eSIM Turkije:</em> <span style="white-space: normal">blijf verbonden tijdens je reis</span></h1>
            <p class="europe-hero-description">Reis door Turkije met één prepaid eSIM. Blijf verbonden in Istanbul, Ankara, Antalya en daarbuiten zonder je fysieke simkaart te vervangen.</p>
            <div class="europe-actions">
              <v-btn color="#d91c58" rounded="pill" size="x-large" elevation="0" class="europe-primary" @click="scrollEuropePlans"> Bekijk bundels voor Turkije<v-icon end>mdi-arrow-down</v-icon>
              </v-btn>
            </div>
          ...
          <div class="europe-visual" style="--hero-bottom-trim: 4.75260%">
            <div class="europe-map-card">
              <img :src="turkeyHeroImage" alt="Bezienswaardigheden in Turkije met eSIM-verbinding">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section class="turkey-proof-strip">
      <v-container class="turkey-proof-grid destination-proof-grid">
        ...
        <div class="destination-proof-item"><v-icon size="26" aria-hidden="true">mdi-signal</v-icon><b>Türk Telekom &amp; Turkcell</b></div>
      </v-container>
    </section>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <h2>Kies je eSIM-bundel voor Turkije</h2>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <p>Controleer je bundel voor Turkije en vul je gegevens voor levering en veilige betaling in.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>Uitleg over de eSIM voor Turkije</span>
          <h2>Wat is een eSIM voor Turkije?</h2>
          <p>Een eSIM voor Turkije is een digitale simkaart voor mobiele data in Turkije, zonder een fysieke simkaart te plaatsen of op te halen.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>Geldigheid begint bij verbinding</b><small>De bundel begint wanneer de eSIM voor het eerst verbinding maakt met een ondersteund netwerk in Turkije.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>Dekking in Turkije</b><small>Gebruik dezelfde eSIM wanneer je tussen gedekte locaties in Turkije reist.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Mobiele netwerken en dekking in Turkije</h2>
          <p>Je eSIM voor Turkije maakt verbinding met ondersteunde partnernetwerken, met 4G/LTE en 5G waar lokaal beschikbaar.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="Partnernetwerken in Turkije">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>Land</th><th>Partnernetwerk(en)</th></tr></thead>
            <tbody>
              <tr><th>🇹🇷 Turkije</th><td><span class="network-operators">AVEA .Iletisim Hizmetleri A.S<br>Turkcell Iletisim Hizmetleri A.S.</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>Laat dataroaming ingeschakeld op de eSIM tijdens je reis in Turkije.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Voor wie is een eSIM voor Turkije geschikt?</h2>
          <p>Een eSIM voor Turkije is handig voor vakanties, stedentrips, zakenreizen en langere verblijven in Turkije.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>Stedentrip naar Istanbul</b><p>Gebruik kaarten, berichtenapps en boekingsapps tijdens je hele verblijf.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-beach</v-icon><div><b>Middellandse Zeekust</b><p>Blijf verbonden tijdens je bezoek aan Antalya, Bodrum of nabijgelegen bestemmingen.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-image-filter-hdr</v-icon><div><b>Cappadocië en Centraal-Turkije</b><p>Houd mobiele data beschikbaar voor vervoer en reserveringen.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-map-marker-path</v-icon><div><b>Reizen langs meerdere steden</b><p>Gebruik één eSIM tijdens je reis tussen Turkse steden.</p></div></div>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activeer op je bestemming</b><p>Schakel na aankomst in Turkije SafarSIM in, selecteer deze voor mobiele data en zet dataroaming aan.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>Werkt WhatsApp met een eSIM voor Turkije?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Waarom kiezen voor SafarSim voor je eSIM voor Turkije?</h2>
          <p>SafarSim biedt een eenvoudige digitale manier om mobiele data in Turkije te kopen en te gebruiken.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Online aankoop</b><p>Kies en koop je databundel voor Turkije online.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Dekking in Turkije</b><p>Gebruik dezelfde eSIM in alle gedekte gebieden in Turkije.</p></div></div>
    ...
    <section class="turkey-policy-section">
      <v-container class="turkey-policy-container">
        <div class="europe-section-heading compact">
          <span>Belangrijk vóór vertrek</span>
          <h2>eSIM-beperkingen in Turkije: hoe bereid je je voor?</h2>
          <p>Turkije heeft eSIM-technologie niet verboden. De beperkingen betreffen vooral toegang vanuit sommige Turkse netwerken tot websites en apps van verschillende internationale eSIM-aanbieders.</p>
        </div>
        <div class="turkey-policy-copy">
          <p>Koop en installeer je SafarSim eSIM vóór vertrek, terwijl je nog in je woonland bent. Bewaar de QR-code en installatie-instructies offline op je telefoon.</p>
          <p>Selecteer in Turkije SafarSim voor mobiele data en schakel dataroaming in. Een al geïnstalleerde eSIM kan verbinding maken met beschikbare partnernetwerken zonder toegang tot de website van de aanbieder.</p>
          <p><strong>SafarSim is getest vanuit Europe en werkt voor reizen in Turkije wanneer je deze vóór vertrek koopt en installeert.</strong> De netwerkdienst blijft afhankelijk van lokale dekking, telefooncompatibiliteit en netwerkomstandigheden.</p>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Veelgestelde vragen over de eSIM voor Turkije</h2>
          <p>Praktische antwoorden om je eSIM voor Turkije goed voor te bereiden en te gebruiken.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>Werkt de eSIM in heel Turkije?</span><v-icon>mdi-plus</v-icon></summary><p>Deze maakt verbinding met ondersteunde partnernetwerken waar compatibele dekking beschikbaar is in Turkije.</p></details>
          ...
          <details><summary><span>Is 5G beschikbaar?</span><v-icon>mdi-plus</v-icon></summary><p>5G is beschikbaar waar het partnernetwerk en je toestel dit ondersteunen; anders gebruikt de eSIM 4G/LTE.</p></details>
          ...
          <details><summary><span>Werkt deze wanneer ik door Turkije reis?</span><v-icon>mdi-plus</v-icon></summary><p>Dezelfde eSIM blijft geïnstalleerd en selecteert automatisch een beschikbaar ondersteund netwerk.</p></details>
          <details><summary><span>Kan ik de eSIM voor Turkije opwaarderen?</span><v-icon>mdi-plus</v-icon></summary><p>Of opwaarderen mogelijk is, hangt af van de gekozen bundel. Koop een nieuwe bundel als opwaarderen niet beschikbaar is.</p></details>
    ...
    <div class="europe-last-updated">
      <v-container><v-icon size="17">mdi-calendar-check-outline</v-icon><span>Informatie bijgewerkt op 2 september 2026.</span></v-container>
    </div>
...
import turkeyHeroImage from '@/assets/images/hero_turkey.png'

export default {
  name: 'TurkeyDutchPage',
  ...
  methods: {
    ...
    loadRegion() {
      this.region = destinations.find((item) => item.slug === 'turquie') || null
    },
    ...
    updateStructuredData() {
      const locale = 'nl'
      const path = `${this.localePrefix}/esim/turkiye`
      ...
      document.title = destinationTitle("Turkije", "nl")
    },
  },
  ...
  mounted() {
    ...
    this.restoreMetadata = applyPageMetadata({
      title: destinationTitle("Turkije", "nl"),
