<template>
  <div class="europe-page" dir="ltr">
      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>Blijf verbonden in heel</span><em>Egypte</em></h1>
            <p class="europe-hero-description">Reis door Egypte met één prepaid eSIM. Blijf verbonden in Caïro, Luxor, Hurghada en daarbuiten zonder je fysieke simkaart te vervangen.</p>
            <div class="europe-actions">
              <v-btn color="#d91c58" rounded="pill" size="x-large" elevation="0" class="europe-primary" @click="scrollEuropePlans"> Bekijk bundels voor Egypte<v-icon end>mdi-arrow-down</v-icon>
              </v-btn>
            </div>
          ...
          <div class="europe-visual" style="--hero-bottom-trim: 0%">
            <div class="europe-map-card">
              <img :src="egyptHeroImage" alt="Bezienswaardigheden in Egypte met eSIM-verbinding">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section class="egypt-proof-strip">
      <v-container class="egypt-proof-grid destination-proof-grid">
        ...
        <div class="destination-proof-item"><v-icon size="26" aria-hidden="true">mdi-signal</v-icon><b>Orange Egypt &amp; Etisalat</b></div>
      </v-container>
    </section>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <h2>Kies je eSIM-bundel voor Egypte</h2>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <p>Controleer je bundel voor Egypte en vul je gegevens voor levering en veilige betaling in.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>Uitleg over de eSIM voor Egypte</span>
          <h2>Wat is een eSIM voor Egypte?</h2>
          <p>Een eSIM voor Egypte is een digitale simkaart voor mobiele data in Egypte, zonder een fysieke simkaart te plaatsen of op te halen.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>Geldigheid begint bij verbinding</b><small>De bundel begint wanneer de eSIM voor het eerst verbinding maakt met een ondersteund netwerk in Egypte.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>Dekking in Egypte</b><small>Gebruik dezelfde eSIM wanneer je tussen gedekte locaties in Egypte reist.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Mobiele netwerken en dekking in Egypte</h2>
          <p>Je eSIM voor Egypte maakt verbinding met ondersteunde partnernetwerken, met 4G/LTE en 5G waar lokaal beschikbaar.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="Partnernetwerken in Egypte">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>Land</th><th>Partnernetwerk(en)</th></tr></thead>
            <tbody>
              <tr><th>🇪🇬 Egypte</th><td><span class="network-operators">Orange Egypt<br>Etisalat</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>Laat dataroaming ingeschakeld op de eSIM tijdens je reis in Egypte.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Voor wie is een eSIM voor Egypte geschikt?</h2>
          <p>Een eSIM voor Egypte is handig voor vakanties, stedentrips, zakenreizen en langere verblijven in Egypte.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>Stedentrip naar Caïro</b><p>Gebruik kaarten, berichtenapps en boekingsapps tijdens je hele verblijf.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-beach</v-icon><div><b>Kust van de Rode Zee</b><p>Blijf verbonden tijdens je bezoek aan Hurghada, Sharm el-Sheikh of nabijgelegen bestemmingen.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-image-filter-hdr</v-icon><div><b>Luxor en de Nijl</b><p>Houd mobiele data beschikbaar voor vervoer en reserveringen.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-map-marker-path</v-icon><div><b>Reizen langs meerdere steden</b><p>Gebruik één eSIM tijdens je reis tussen steden in Egypte.</p></div></div>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activeer op je bestemming</b><p>Schakel na aankomst in Egypte SafarSIM in, selecteer deze voor mobiele data en zet dataroaming aan.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>Werkt WhatsApp met een eSIM voor Egypte?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Waarom kiezen voor SafarSim voor je eSIM voor Egypte?</h2>
          <p>SafarSim biedt een eenvoudige digitale manier om mobiele data in Egypte te kopen en te gebruiken.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Online aankoop</b><p>Kies en koop je databundel voor Egypte online.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Dekking in Egypte</b><p>Gebruik dezelfde eSIM in alle gedekte gebieden in Egypte.</p></div></div>
    ...
    <section class="egypt-policy-section">
      <v-container class="egypt-policy-container">
        <div class="europe-section-heading compact">
          <span>Vóór je reis</span>
          <h2>Bereid je eSIM voor Egypte voor</h2>
          <p>Met een paar eenvoudige stappen ben je bij aankomst verbonden.</p>
        </div>
        <div class="egypt-policy-copy">
          <p>Controleer of je telefoon eSIM ondersteunt en simlockvrij is. Installeer je SafarSim eSIM vóór vertrek via een stabiele wifiverbinding.</p>
          <p>Bewaar je QR-code en installatie-instructies offline. Selecteer bij aankomst in Egypte SafarSim voor mobiele data en schakel dataroaming in.</p>
          <p>De dekking hangt af van je locatie, toestel en beschikbare partnernetwerken.</p>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Veelgestelde vragen over de eSIM voor Egypte</h2>
          <p>Praktische antwoorden om je eSIM voor Egypte goed voor te bereiden en te gebruiken.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>Werkt de eSIM in heel Egypte?</span><v-icon>mdi-plus</v-icon></summary><p>Deze maakt verbinding met ondersteunde partnernetwerken waar compatibele dekking beschikbaar is in Egypte.</p></details>
          ...
          <details><summary><span>Werkt deze wanneer ik door Egypte reis?</span><v-icon>mdi-plus</v-icon></summary><p>Dezelfde eSIM blijft geïnstalleerd en selecteert automatisch een beschikbaar ondersteund netwerk.</p></details>
          <details><summary><span>Kan ik de eSIM voor Egypte opwaarderen?</span><v-icon>mdi-plus</v-icon></summary><p>Of opwaarderen mogelijk is, hangt af van de gekozen bundel. Koop een nieuwe bundel als opwaarderen niet beschikbaar is.</p></details>
...
export default {
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = destinationTitle("Egypte", "nl")
    },
  },
  ...
  mounted() {
    ...
    this.restoreMetadata = applyPageMetadata({
      title: destinationTitle("Egypte", "nl"),
