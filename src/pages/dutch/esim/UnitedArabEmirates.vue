      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>Blijf verbonden in de</span><em style="--country-title-size: 7cqw">Verenigde Arabische Emiraten</em></h1>
            <p class="europe-hero-description">Ontdek de VAE met één prepaid eSIM. Blijf verbonden in Dubai, Abu Dhabi, Sharjah en alle zeven emiraten zonder je fysieke simkaart te vervangen.</p>
          ...
          <div class="europe-visual" style="--hero-bottom-trim: 1.75781%">
            <div class="europe-map-card">
              <img :src="uaeHeroImage" alt="Bezienswaardigheden in Verenigde Arabische Emiraten met eSIM-verbinding">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <h2>Kies je eSIM-bundel voor Verenigde Arabische Emiraten</h2>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <p>Controleer je bundel voor Verenigde Arabische Emiraten en vul je gegevens voor levering en veilige betaling in.</p>
        </div>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Mobiele netwerken en dekking in Verenigde Arabische Emiraten</h2>
          <p>Je eSIM voor Verenigde Arabische Emiraten maakt verbinding met ondersteunde partnernetwerken, met 4G/LTE en 5G waar lokaal beschikbaar.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="Partnernetwerken in Verenigde Arabische Emiraten">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>Land</th><th>Partnernetwerk(en)</th></tr></thead>
            <tbody>
              <tr><th>🇦🇪 Verenigde Arabische Emiraten</th><td><span class="network-operators">Etisalat<br>du</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Voor wie is een eSIM voor Verenigde Arabische Emiraten geschikt?</h2>
          <p>Een eSIM voor Verenigde Arabische Emiraten is handig voor vakanties, stedentrips, zakenreizen en langere verblijven in Verenigde Arabische Emiraten.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>Stedentrip naar Dubai</b><p>Gebruik kaarten, berichtenapps, taxiapps en boekingsapps tijdens je hele verblijf.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-mosque</v-icon><div><b>Abu Dhabi en de Grote Moskee</b><p>Blijf verbonden voor routebeschrijvingen, tickets en reisplanning.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-beach</v-icon><div><b>Stranden en woestijnavonturen</b><p>Houd mobiele data beschikbaar voor vervoer, reserveringen en het delen van je reis.</p></div></div>
    ...
    <section class="europe-installation-section">
      <v-container class="europe-installation-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Zo installeer je je eSIM voor Verenigde Arabische Emiraten</h2>
          <p>Koop en installeer je eSIM vóór vertrek en activeer deze op het juiste moment.</p>
        </div>
        <ol class="europe-installation-steps">
          <li><i>1</i><span>Kies je bundel voor Verenigde Arabische Emiraten.</span></li>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activeer op je bestemming</b><p>Schakel na aankomst in Verenigde Arabische Emiraten SafarSIM in, selecteer deze voor mobiele data en zet dataroaming aan.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>Werkt WhatsApp met een eSIM voor Verenigde Arabische Emiraten?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Waarom kiezen voor SafarSim voor je eSIM voor Verenigde Arabische Emiraten?</h2>
          <p>SafarSim biedt een eenvoudige digitale manier om mobiele data in Verenigde Arabische Emiraten te kopen en te gebruiken.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Online aankoop</b><p>Kies en koop je databundel voor Verenigde Arabische Emiraten online.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Dekking in Verenigde Arabische Emiraten</b><p>Gebruik dezelfde eSIM in alle gedekte gebieden in Verenigde Arabische Emiraten.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Veelgestelde vragen over de eSIM voor Verenigde Arabische Emiraten</h2>
          <p>Praktische antwoorden om je eSIM voor Verenigde Arabische Emiraten goed voor te bereiden en te gebruiken.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>Werkt de eSIM in heel Verenigde Arabische Emiraten?</span><v-icon>mdi-plus</v-icon></summary><p>Deze maakt verbinding met ondersteunde partnernetwerken waar compatibele dekking beschikbaar is in Verenigde Arabische Emiraten.</p></details>
          ...
          <details><summary><span>Werkt deze wanneer ik door Verenigde Arabische Emiraten reis?</span><v-icon>mdi-plus</v-icon></summary><p>Dezelfde eSIM blijft geïnstalleerd en selecteert automatisch een beschikbaar ondersteund netwerk.</p></details>
...
export default {
  ...
  data() {
    return {
      ...
      countryNameOverrides: {
        ...
        ES: 'Espagne',
        FI: 'Finlande',
        FR: "Verenigde Arabische Emiraten",
        GB: 'Royaume-Uni',
        GE: 'Géorgie',
        GF: 'Guyane française',
        GR: 'Grèce',
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = destinationTitle("Verenigde Arabische Emiraten", "nl")
    },
  },
  ...
  mounted() {
    ...
    this.restoreMetadata = applyPageMetadata({
      title: destinationTitle("Verenigde Arabische Emiraten", "nl"),
