  ...
  <div class="europe-page" dir="ltr">
      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>Blijf verbonden in heel</span><em>Europa</em></h1>
            <p class="europe-hero-description">Reis van Lissabon naar Istanbul met één prepaid eSIM. Geen verrassende roamingkosten of simkaartwissels, maar betrouwbare data tijdens je hele reis.</p>
          ...
          <div class="europe-visual" style="--hero-bottom-trim: 2.21354%">
            <div class="europe-map-card">
              <img :src="europeHeroImage" alt="Bezienswaardigheden in Europa met eSIM-verbinding">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section class="destination-benefits-strip">
      <v-container class="destination-proof-grid">
        <div class="destination-proof-item"><v-icon size="26" aria-hidden="true">mdi-tag-outline</v-icon><b>Bundels vanaf {{ startingPrice }}</b></div>
        <div class="destination-proof-item"><v-icon size="26" aria-hidden="true">mdi-lightning-bolt-outline</v-icon><b>Directe levering</b></div>
        <div class="destination-proof-item"><v-icon size="26" aria-hidden="true">mdi-cash-check</v-icon><b>Geen roamingkosten</b></div>
        <div class="destination-proof-item"><v-icon size="26" aria-hidden="true">mdi-signal</v-icon><b>38 gedekte landen</b></div>
      </v-container>
    </section>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          <span>Flexibele prepaid data</span>
          <h2>Kies je eSIM-bundel voor Europa</h2>
          <div class="destination-plan-trust">
              <span><v-icon size="19" aria-hidden="true">mdi-lock-outline</v-icon>Veilig betalen</span>
              <span><v-icon size="19" aria-hidden="true">mdi-currency-usd</v-icon>Beleid voor volledige terugbetaling</span>
            </div>
        </div>
        <div class="europe-plan-grid">
          <button v-for="plan in sortedPlans" :key="plan.key" type="button" class="europe-plan-card" :class="{ active: selectedPlanKey === plan.key }" @click="handleAddToCart(plan)">
            <span v-if="plan.data === '10GB'" class="popular-label">Meest populair</span>
            <span class="plan-radio" aria-hidden="true"></span>
            <div class="plan-data"><b>{{ plan.dataLabel }}</b></div>
            <div class="plan-duration"><v-icon size="19">mdi-calendar-blank-outline</v-icon>{{ plan.days }} dagen</div>
            <div class="plan-price">{{ formatPriceFromMad(plan.price, 'nl') }}</div>
          </button>
        </div>
        <details class="covered-countries-compact">
          <summary><v-icon>mdi-map-marker-multiple-outline</v-icon><strong>38 gedekte landen</strong><v-icon class="covered-toggle">mdi-chevron-down</v-icon></summary>
          <div class="covered-country-chips">
            <router-link to="/nl/esim/autriche"><img :src="getFlagImage('AT')" alt="Oostenrijk"><span>Oostenrijk</span></router-link>
            <router-link to="/nl/esim/danemark"><img :src="getFlagImage('DK')" alt="Denemarken"><span>Denemarken</span></router-link>
            <router-link to="/nl/esim/irlande"><img :src="getFlagImage('IE')" alt="Ierland"><span>Ierland</span></router-link>
            <router-link to="/nl/esim/italie"><img :src="getFlagImage('IT')" alt="Italië"><span>Italië</span></router-link>
            <router-link to="/nl/esim/suede"><img :src="getFlagImage('SE')" alt="Zweden"><span>Zweden</span></router-link>
            <router-link to="/nl/esim/france"><img :src="getFlagImage('FR')" alt="Frankrijk"><span>Frankrijk</span></router-link>
            <router-link to="/nl/esim/bulgarie"><img :src="getFlagImage('BG')" alt="Bulgarije"><span>Bulgarije</span></router-link>
            <router-link to="/nl/esim/chypre"><img :src="getFlagImage('CY')" alt="Cyprus"><span>Cyprus</span></router-link>
            <router-link to="/nl/esim/estonie"><img :src="getFlagImage('EE')" alt="Estland"><span>Estland</span></router-link>
            <router-link to="/nl/esim/finlande"><img :src="getFlagImage('FI')" alt="Finland"><span>Finland</span></router-link>
            <router-link to="/nl/esim/grece"><img :src="getFlagImage('GR')" alt="Griekenland"><span>Griekenland</span></router-link>
            <router-link to="/nl/esim/hongrie"><img :src="getFlagImage('HU')" alt="Hongarije"><span>Hongarije</span></router-link>
            <router-link to="/nl/esim/lettonie"><img :src="getFlagImage('LV')" alt="Letland"><span>Letland</span></router-link>
            <router-link to="/nl/esim/lituanie"><img :src="getFlagImage('LT')" alt="Litouwen"><span>Litouwen</span></router-link>
            <router-link to="/nl/esim/pays-bas"><img :src="getFlagImage('NL')" alt="Nederland"><span>Nederland</span></router-link>
            <router-link to="/nl/esim/norvege"><img :src="getFlagImage('NO')" alt="Noorwegen"><span>Noorwegen</span></router-link>
            <router-link to="/nl/esim/pologne"><img :src="getFlagImage('PL')" alt="Polen"><span>Polen</span></router-link>
            <router-link to="/nl/esim/roumanie"><img :src="getFlagImage('RO')" alt="Roemenië"><span>Roemenië</span></router-link>
            <router-link to="/nl/esim/slovaquie"><img :src="getFlagImage('SK')" alt="Slowakije"><span>Slowakije</span></router-link>
            <router-link to="/nl/esim/spain"><img :src="getFlagImage('ES')" alt="Spanje"><span>Spanje</span></router-link>
            <router-link to="/nl/esim/royaume-uni"><img :src="getFlagImage('GB')" alt="Verenigd Koninkrijk"><span>Verenigd Koninkrijk</span></router-link>
            <router-link to="/nl/esim/turkiye"><img :src="getFlagImage('TR')" alt="Turkije"><span>Turkije</span></router-link>
            <router-link to="/nl/esim/allemagne"><img :src="getFlagImage('DE')" alt="Duitsland"><span>Duitsland</span></router-link>
            <router-link to="/nl/esim/malte"><img :src="getFlagImage('MT')" alt="Malta"><span>Malta</span></router-link>
            <router-link to="/nl/esim/suisse"><img :src="getFlagImage('CH')" alt="Zwitserland"><span>Zwitserland</span></router-link>
            <router-link to="/nl/esim/belgique"><img :src="getFlagImage('BE')" alt="België"><span>België</span></router-link>
            <router-link to="/nl/esim/croatie"><img :src="getFlagImage('HR')" alt="Kroatië"><span>Kroatië</span></router-link>
            <router-link to="/nl/esim/republique-tcheque"><img :src="getFlagImage('CZ')" alt="Tsjechië"><span>Tsjechië</span></router-link>
            <router-link to="/nl/esim/liechtenstein"><img :src="getFlagImage('LI')" alt="Liechtenstein"><span>Liechtenstein</span></router-link>
            <router-link to="/nl/esim/luxembourg"><img :src="getFlagImage('LU')" alt="Luxemburg"><span>Luxemburg</span></router-link>
            <router-link to="/nl/esim/portugal"><img :src="getFlagImage('PT')" alt="Portugal"><span>Portugal</span></router-link>
            <router-link to="/nl/esim/slovenie"><img :src="getFlagImage('SI')" alt="Slovenië"><span>Slovenië</span></router-link>
            <router-link to="/nl/esim/islande"><img :src="getFlagImage('IS')" alt="IJsland"><span>IJsland</span></router-link>
            <router-link to="/nl/esim/iles-canaries"><img :src="getFlagImage('IC')" alt="Canarische Eilanden"><span>Canarische Eilanden</span></router-link>
            <router-link to="/nl/esim/cite-du-vatican"><img :src="getFlagImage('VA')" alt="Vaticaanstad"><span>Vaticaanstad</span></router-link>
            <router-link to="/nl/esim/cyp"><img :src="getFlagImage('CYP')" alt="Cyprus"><span>Cyprus</span></router-link>
            <router-link to="/nl/esim/moldavie"><img :src="getFlagImage('MD')" alt="Moldavië"><span>Moldavië</span></router-link>
            <router-link to="/nl/esim/serbie"><img :src="getFlagImage('RS')" alt="Servië"><span>Servië</span></router-link>
          </div>
        </details>
        <v-btn v-if="selectedPlanKey" color="#d91c58" rounded="pill" size="x-large" elevation="0" class="europe-purchase-cta" @click="scrollToCheckout"> Verder naar veilig betalen<v-icon end>mdi-arrow-down</v-icon>
        </v-btn>
      </v-container>
    </section>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <h2>Rond je bestelling af</h2>
          <p>Controleer je bundel voor Europa en vul je gegevens voor levering en veilige betaling in.</p>
        </div>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          <span>Lokale netwerkpartners</span>
          <h2>Mobiele netwerken en dekking in Europa</h2>
          <p>Je eSIM voor Europa maakt verbinding met ondersteunde partnernetwerken in de inbegrepen landen, met 4G/LTE en 5G waar lokaal beschikbaar.</p>
        </div>
        <details class="network-disclosure">
          <summary><span>Bekijk alle partnernetwerken</span><v-icon>mdi-chevron-down</v-icon></summary>
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>Land</th><th>Partnernetwerk(en)</th></tr></thead>
            <tbody>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/autriche`"><img :src="getFlagImage('AT')" alt="Oostenrijk"><b>Oostenrijk</b></router-link></td><td><span class="network-operators">Hutchinson Austria · A1 Austria · 3 Austria</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/danemark`"><img :src="getFlagImage('DK')" alt="Denemarken"><b>Denemarken</b></router-link></td><td><span class="network-operators">Hutchinson Denmark · Telia Denmark · TDC</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/irlande`"><img :src="getFlagImage('IE')" alt="Ierland"><b>Ierland</b></router-link></td><td><span class="network-operators">3 Ireland · Meteor Mobile Ireland · Vodafone Ireland</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/italie`"><img :src="getFlagImage('IT')" alt="Italië"><b>Italië</b></router-link></td><td><span class="network-operators">Windtre · Iliad · Vodafone Italy</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/suede`"><img :src="getFlagImage('SE')" alt="Zweden"><b>Zweden</b></router-link></td><td><span class="network-operators">Telia Sweden · Hutchinson Sweden · Tele2 Sverige</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/france`"><img :src="getFlagImage('FR')" alt="Frankrijk"><b>Frankrijk</b></router-link></td><td><span class="network-operators">Orange France · Bouygues Télécom · Free Mobile Iliad</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/bulgarie`"><img :src="getFlagImage('BG')" alt="Bulgarije"><b>Bulgarije</b></router-link></td><td><span class="network-operators">A1 Bulgaria · Cetin Bulgaria · Vivacom Bulgaria</span><span class="technology-badge">4G / 5G</span></td></tr>
              ...
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/estonie`"><img :src="getFlagImage('EE')" alt="Estland"><b>Estland</b></router-link></td><td><span class="network-operators">Telia Eesti · Elisa Eesti · Tele2 Eesti</span><span class="technology-badge">4G / 5G</span></td></tr>
              ...
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/grece`"><img :src="getFlagImage('GR')" alt="Griekenland"><b>Griekenland</b></router-link></td><td><span class="network-operators">NOVA Telemach · Vodafone Greece · NOVA</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/hongrie`"><img :src="getFlagImage('HU')" alt="Hongarije"><b>Hongarije</b></router-link></td><td><span class="network-operators">Yettel · Vodafone · Magyar Telekom</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/lettonie`"><img :src="getFlagImage('LV')" alt="Letland"><b>Letland</b></router-link></td><td><span class="network-operators">LMT Latvia · Bite Latvija · Tele2</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/lituanie`"><img :src="getFlagImage('LT')" alt="Litouwen"><b>Litouwen</b></router-link></td><td><span class="network-operators">Telia Lietuva · Bite Lithuania · Tele2</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/pays-bas`"><img :src="getFlagImage('NL')" alt="Nederland"><b>Nederland</b></router-link></td><td><span class="network-operators">KPN · Vodafone Libertel</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/norvege`"><img :src="getFlagImage('NO')" alt="Noorwegen"><b>Noorwegen</b></router-link></td><td><span class="network-operators">Telia Norge · ICE</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/pologne`"><img :src="getFlagImage('PL')" alt="Polen"><b>Polen</b></router-link></td><td><span class="network-operators">Polkomtel · Orange Polska · Play</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/roumanie`"><img :src="getFlagImage('RO')" alt="Roemenië"><b>Roemenië</b></router-link></td><td><span class="network-operators">Orange Romania · Vodafone Romania · Telekom Romania</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/slovaquie`"><img :src="getFlagImage('SK')" alt="Slowakije"><b>Slowakije</b></router-link></td><td><span class="network-operators">Orange Slovensko · O2 Slovakia</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/spain`"><img :src="getFlagImage('ES')" alt="Spanje"><b>Spanje</b></router-link></td><td><span class="network-operators">Orange Spain · Movistar · Vodafone Spain</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/royaume-uni`"><img :src="getFlagImage('GB')" alt="Verenigd Koninkrijk"><b>Verenigd Koninkrijk</b></router-link></td><td><span class="network-operators">Three UK · Virgin Media O2 · Vodafone</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/turkiye`"><img :src="getFlagImage('TR')" alt="Turkije"><b>Turkije</b></router-link></td><td><span class="network-operators">AVEA · Turkcell</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/allemagne`"><img :src="getFlagImage('DE')" alt="Duitsland"><b>Duitsland</b></router-link></td><td><span class="network-operators">Telefonica Germany · Vodafone Germany</span><span class="technology-badge">4G / 5G</span></td></tr>
              ...
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/suisse`"><img :src="getFlagImage('CH')" alt="Zwitserland"><b>Zwitserland</b></router-link></td><td><span class="network-operators">Salt Mobile · Swisscom · Sunrise</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/belgique`"><img :src="getFlagImage('BE')" alt="België"><b>België</b></router-link></td><td><span class="network-operators">Proximus Belgium · Orange Belgium · Telenet</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/croatie`"><img :src="getFlagImage('HR')" alt="Kroatië"><b>Kroatië</b></router-link></td><td><span class="network-operators">Telemach Croatia · A1 Croatia · Hrvatski Telekom</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/republique-tcheque`"><img :src="getFlagImage('CZ')" alt="Czech Republic"><b>Tsjechië</b></router-link></td><td><span class="network-operators">O2 Czech Republic · T-Mobile Czech · Vodafone Tsjechië</span><span class="technology-badge">4G / 5G</span></td></tr>
              ...
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/luxembourg`"><img :src="getFlagImage('LU')" alt="Luxemburg"><b>Luxemburg</b></router-link></td><td><span class="network-operators">Proximus Tango · Orange Luxembourg · POST Luxembourg</span><span class="technology-badge">4G / 5G</span></td></tr>
              ...
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/slovenie`"><img :src="getFlagImage('SI')" alt="Slovenië"><b>Slovenië</b></router-link></td><td><span class="network-operators">Telemach Slovenia · A1 Slovenije · Mobitel</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/islande`"><img :src="getFlagImage('IS')" alt="IJsland"><b>IJsland</b></router-link></td><td><span class="network-operators">Nova Iceland · Siminn · Syn</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/iles-canaries`"><img :src="getFlagImage('IC')" alt="Canarische Eilanden"><b>Canarische Eilanden</b></router-link></td><td><span class="network-operators">Orange Spain · Vodafone Spain · Xfera Moviles</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/cite-du-vatican`"><img :src="getFlagImage('VA')" alt="Vaticaanstad"><b>Vaticaanstad</b></router-link></td><td><span class="network-operators">Windtre · Iliad · Vodafone Italy</span><span class="technology-badge">4G / 5G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/moldavie`"><img :src="getFlagImage('MD')" alt="Moldavië"><b>Moldavië</b></router-link></td><td><span class="network-operators">Orange · Mold Telecom · Moldcell</span><span class="technology-badge">4G</span></td></tr>
              <tr><td><router-link class="network-country-link" :to="`${localePrefix}/esim/serbie`"><img :src="getFlagImage('RS')" alt="Servië"><b>Servië</b></router-link></td><td><span class="network-operators">Telenor/Cetin · A1/VIP · Telekom Srbija</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </details>
        <div class="network-notes network-notes-after-table">
          <span><v-icon size="20">mdi-access-point-network</v-icon>Je toestel selecteert automatisch een beschikbaar partnernetwerk.</span>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          <span>Eén bundel voor elke tussenstop</span>
          <h2>Voor wie is een eSIM voor Europa geschikt?</h2>
          <p>Een eSIM voor Europa is vooral handig als je tijdens dezelfde reis meerdere landen bezoekt.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-map-marker-path</v-icon><div><b>Spanje + Portugal</b><p>Blijf verbonden tijdens je reis over het Iberisch Schiereiland zonder van simkaart te wisselen.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-train</v-icon><div><b>Frankrijk + België + Nederland</b><p>Gebruik dezelfde databundel tijdens je reis tussen drie buurlanden.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-image-filter-hdr</v-icon><div><b>Italië + Zwitserland</b><p>Houd kaarten, boekingen en berichten aan beide kanten van de grens beschikbaar.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>Reizen langs meerdere Europese steden</b><p>Ideaal voor vakanties waarbij je meerdere steden en landen combineert.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-briefcase-outline</v-icon><div><b>Zakenreizen door Europa</b><p>Behoud één betrouwbare verbinding voor vergaderingen, vervoer en werkapps.</p></div></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-comparison-section">
      <v-container class="europe-comparison-container">
        <div class="europe-section-heading compact">
          <span>Kies de juiste dekking</span>
          <h2>Een eSIM voor Europa of voor één land?</h2>
          <p>De beste keuze hangt vooral af van het aantal landen dat je wilt bezoeken.</p>
        </div>
        <div class="comparison-table-wrap">
          <table class="comparison-table">
            <thead>
              <tr><th></th><th>eSIM voor Europa</th><th>eSIM voor één land</th></tr>
            </thead>
            <tbody>
              <tr><th>Reizen in één land</th><td>Mogelijk</td><td>Vaak geschikter</td></tr>
              <tr><th>Meerdere landen</th><td>Ideaal</td><td>Meerdere eSIMs nodig</td></tr>
              <tr><th>Van land wisselen</th><td>Dezelfde eSIM</td><td>Mogelijk een andere eSIM nodig</td></tr>
              <tr><th>Gebruiksgemak</th><td>Zeer hoog</td><td>Hoog</td></tr>
            </tbody>
          </table>
        </div>
        <div class="comparison-recommendation">
          <v-icon>mdi-lightbulb-on-outline</v-icon>
          <p>Als je slechts één week in Spanje reist, kan een eSIM voor Spanje geschikter zijn. Als je Spanje, Portugal en Frankrijk bezoekt, is een Europabundel doorgaans handiger.</p>
        </div>
        <div class="comparison-links">
          <router-link :to="`${localePrefix}/esim/spain`"><span class="comparison-link-label">Bekijk eSIMs voor Spanje <span class="comparison-link-flag">🇪🇸</span></span><v-icon size="17">mdi-arrow-right</v-icon></router-link>
          <router-link :to="`${localePrefix}/esim/france`"><span class="comparison-link-label">Bekijk eSIMs voor Frankrijk <span class="comparison-link-flag">🇫🇷</span></span><v-icon size="17">mdi-arrow-right</v-icon></router-link>
          <router-link :to="`${localePrefix}/esim/portugal`"><span class="comparison-link-label">Bekijk eSIMs voor Portugal <span class="comparison-link-flag">🇵🇹</span></span><v-icon size="17">mdi-arrow-right</v-icon></router-link>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-installation-section">
      <v-container class="europe-installation-container">
        <div class="europe-section-heading compact">
          <span>Klaar in enkele minuten</span>
          <h2>Zo installeer je je eSIM voor Europa</h2>
          <p>Koop en installeer je eSIM vóór vertrek en activeer deze op het juiste moment.</p>
        </div>
        <ol class="europe-installation-steps">
          <li><i>1</i><span>Kies je bundel voor Europa.</span></li>
          <li><i>2</i><span>Rond je betaling af.</span></li>
          <li><i>3</i><span>Ontvang je QR-code.</span></li>
          <li><i>4</i><span>Voeg de eSIM toe in je telefooninstellingen.</span></li>
          <li><i>5</i><span>Schakel mobiele data op het juiste moment in.</span></li>
        </ol>
        <div class="europe-guide-links">
          <router-link :to="`${localePrefix}/guides/install-esim-iphone`"><v-icon>mdi-apple</v-icon><span>Installatiehandleiding voor eSIM op iPhone</span><v-icon size="19">mdi-arrow-right</v-icon></router-link>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        <div class="europe-section-heading compact"><span>Installeer nu, maak verbinding bij aankomst</span><h2>Wanneer moet je je eSIM voor Europa installeren en activeren?</h2><p>Je kunt de eSIM vóór vertrek installeren. Alle SafarSIM-bundels starten automatisch wanneer de eSIM voor het eerst verbinding maakt met een ondersteund netwerk en dataroaming is ingeschakeld.</p></div>
        <div class="activation-guidance">
          <div><v-icon>mdi-download-circle-outline</v-icon><span><b>Installeer vóór je reis</b><p>Gebruik stabiele wifi om de QR-code te scannen en de eSIM aan je telefoon toe te voegen.</p></span></div>
          <div><v-icon>mdi-timer-play-outline</v-icon><span><b>Geldigheid begint bij verbinding</b><p>De looptijd begint niet alleen door het installeren van het profiel. Deze begint bij verbinding met een ondersteund netwerk terwijl dataroaming is ingeschakeld.</p></span></div>
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activeer op je bestemming</b><p>Schakel na aankomst in Europa SafarSIM in, selecteer deze voor mobiele data en zet dataroaming aan.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>Werkt WhatsApp met een eSIM voor Europa?</h2>
        </div>
        <p>Ja. Een eSIM voor alleen data verandert doorgaans het nummer van je WhatsApp-account niet. Je kunt WhatsApp met je gebruikelijke nummer blijven gebruiken terwijl SafarSIM de mobiele dataverbinding verzorgt.</p>
      </v-container>
    </section>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          <span>Een volledig digitale dienst</span>
          <h2>Waarom kiezen voor SafarSim voor je eSIM voor Europa?</h2>
          <p>SafarSim biedt een eenvoudige digitale manier om mobiele data in meerdere Europese landen te kopen en te gebruiken.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Online aankoop</b><p>Kies en koop je databundel voor Europa online.</p></div></div>
          <div class="safarsim-fact-card"><v-icon>mdi-qrcode-scan</v-icon><div><b>Digitale QR-code</b><p>Je QR-code voor installatie wordt digitaal geleverd.</p></div></div>
          <div class="safarsim-fact-card"><v-icon>mdi-signal</v-icon><div><b>Verschillende databundels</b><p>Kies de hoeveelheid data en geldigheidsduur die bij je reis passen.</p></div></div>
          <div class="safarsim-fact-card"><v-icon>mdi-headset</v-icon><div><b>Klantenservice</b><p>Er is ondersteuning beschikbaar als je hulp nodig hebt met je eSIM.</p></div></div>
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Dekking in meerdere landen</b><p>Gebruik dezelfde eSIM voor Europa in alle inbegrepen landen.</p></div></div>
          <div class="safarsim-fact-card"><v-icon>mdi-sim-off-outline</v-icon><div><b>Geen fysieke simkaart ophalen</b><p>Je hoeft geen kaart op te halen in een winkel of op de luchthaven.</p></div></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Veelgestelde vragen over de eSIM voor Europa</h2>
          <p>Praktische antwoorden om je eSIM voor Europa goed voor te bereiden en te gebruiken.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>Werkt één eSIM in meerdere Europese landen?</span><v-icon>mdi-plus</v-icon></summary><p>Ja. Dezelfde eSIM voor Europa werkt in alle landen van de bundel, zonder deze bij elke grens te vervangen.</p></details>
          <details><summary><span>Kan ik de eSIM vóór mijn reis installeren?</span><v-icon>mdi-plus</v-icon></summary><p>Ja. Installeer deze vóór vertrek via een stabiele wifiverbinding. De bundel begint bij de eerste verbinding met een ondersteund netwerk terwijl dataroaming is ingeschakeld.</p></details>
          <details><summary><span>Wanneer begint de geldigheid van mijn bundel?</span><v-icon>mdi-plus</v-icon></summary><p>De geldigheid begint wanneer de eSIM voor het eerst verbinding maakt met een ondersteund netwerk, niet alleen wanneer het profiel wordt geïnstalleerd.</p></details>
          <details><summary><span>Kan ik WhatsApp gebruiken met mijn gebruikelijke telefoonnummer?</span><v-icon>mdi-plus</v-icon></summary><p>Ja. Je kunt WhatsApp blijven gebruiken met je gebruikelijke nummer terwijl de SafarSim eSIM mobiele data levert.</p></details>
          <details><summary><span>Mag ik een persoonlijke hotspot gebruiken?</span><v-icon>mdi-plus</v-icon></summary><p>De meeste bundels ondersteunen een persoonlijke hotspot, afhankelijk van je toestel en het lokale partnernetwerk.</p></details>
          <details><summary><span>Is 5G beschikbaar?</span><v-icon>mdi-plus</v-icon></summary><p>5G is beschikbaar waar het lokale partnernetwerk en je toestel dit ondersteunen. Anders maakt de eSIM verbinding via 4G/LTE.</p></details>
          <details><summary><span>Kan ik mijn huidige fysieke simkaart behouden?</span><v-icon>mdi-plus</v-icon></summary><p>Ja, op een telefoon die dual-sim ondersteunt. Behoud je huidige simkaart voor je gebruikelijke nummer en selecteer SafarSim voor mobiele data.</p></details>
          <details><summary><span>Wat gebeurt er als ik naar een ander land reis?</span><v-icon>mdi-plus</v-icon></summary><p>Dezelfde eSIM maakt automatisch verbinding met een beschikbaar partnernetwerk in het volgende gedekte land. Laat dataroaming ingeschakeld op de SafarSim-lijn.</p></details>
    ...
    <section class="europe-related-section">
      <v-container class="europe-related-container">
        <div class="europe-section-heading compact">
          <span>Ontdek per land</span>
          <h2>Populaire eSIMs in Europa</h2>
        </div>
        <div class="europe-related-grid">
          <router-link to="/nl/esim/spain" class="europe-related-card"><img :src="getFlagImage('ES')" alt="Spanje"><strong>eSIM Spanje</strong><v-icon>mdi-arrow-right</v-icon></router-link>
          <router-link to="/nl/esim/france" class="europe-related-card"><img :src="getFlagImage('FR')" alt="Frankrijk"><strong>eSIM Frankrijk</strong><v-icon>mdi-arrow-right</v-icon></router-link>
          <router-link to="/nl/esim/italie" class="europe-related-card"><img :src="getFlagImage('IT')" alt="Italië"><strong>eSIM Italië</strong><v-icon>mdi-arrow-right</v-icon></router-link>
          <router-link to="/nl/esim/portugal" class="europe-related-card"><img :src="getFlagImage('PT')" alt="Portugal"><strong>eSIM Portugal</strong><v-icon>mdi-arrow-right</v-icon></router-link>
          <router-link to="/nl/esim/royaume-uni" class="europe-related-card"><img :src="getFlagImage('GB')" alt="Verenigd Koninkrijk"><strong>eSIM Verenigd Koninkrijk</strong><v-icon>mdi-arrow-right</v-icon></router-link>
          <router-link to="/nl/esim/allemagne" class="europe-related-card"><img :src="getFlagImage('DE')" alt="Duitsland"><strong>eSIM Duitsland</strong><v-icon>mdi-arrow-right</v-icon></router-link>
          <router-link to="/nl/esim/pays-bas" class="europe-related-card"><img :src="getFlagImage('NL')" alt="Nederland"><strong>eSIM Nederland</strong><v-icon>mdi-arrow-right</v-icon></router-link>
          <router-link to="/nl/esim/suisse" class="europe-related-card"><img :src="getFlagImage('CH')" alt="Zwitserland"><strong>eSIM Zwitserland</strong><v-icon>mdi-arrow-right</v-icon></router-link>
        </div>
      </v-container>
    </section>

    <div class="europe-last-updated">
      <v-container><v-icon size="17">mdi-calendar-check-outline</v-icon><span>Informatie bijgewerkt op 1 september 2026.</span></v-container>
    </div>
...
export default {
  ...
  computed: {
    ...
    localizedRegionName() {
      return getLocalizedName(this.region, 'nl')
    },
    ...
    startingPrice() {
      ...
      return Number.isFinite(cheapest) ? formatPriceFromMad(cheapest, 'nl') : ''
    },
    ...
    relatedDestinations() {
      return [
        ...
        { iso: 'CH', slug: 'suisse' },
      ].map((country) => ({ ...country, name: this.getCountryName(country.iso, 'nl') }))
    },
  ...
  methods: {
    ...
    handleAddToCart(plan) {
      ...
      this.snackbarText = "Toegevoegd aan winkelwagen"
      this.snackbar = true
    ...
    updateStructuredData() {
      ...
      const schema = [
        ...
        },
        {
          ...
          category: "eSIM voor op reis",
          offers: this.sortedPlans.map((plan) => ({
            '@type': 'Offer', name: `${plan.dataLabel} · ${plan.days} dagen`,
      ...
      document.title = destinationTitle("Europa", "nl")
    },
  },
  ...
  mounted() {
    ...
    this.restoreMetadata = applyPageMetadata({
      title: destinationTitle("Europa", "nl"),
