      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>Blijf verbonden<br>tijdens de hadj en oemra in</span><em>Saoedi-Arabië</em></h1>
            <p class="europe-hero-description">Bereid je hadj- of oemrareis voor met één prepaid eSIM voor Saoedi-Arabië. Blijf verbonden in Mekka, Medina, Jeddah en de rest van het koninkrijk zonder je fysieke simkaart te vervangen.</p>
            <div class="europe-actions">
              <v-btn color="#d91c58" rounded="pill" size="x-large" elevation="0" class="europe-primary" @click="scrollEuropePlans"> Bekijk bundels voor Saoedi-Arabië<v-icon end>mdi-arrow-down</v-icon>
              </v-btn>
            </div>
          ...
          <div class="europe-visual" style="--hero-bottom-trim: 3.25521%">
            <div class="europe-map-card">
              <img :src="saudiArabiaHeroImage" alt="Bezienswaardigheden in Saoedi-Arabië met eSIM-verbinding">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <h2>Kies je eSIM-bundel voor Saoedi-Arabië</h2>
        ...
        <div class="europe-plan-grid">
          <button v-for="plan in sortedPlans" :key="plan.key" type="button" class="europe-plan-card" :class="{ active: selectedPlanKey === plan.key }" @click="handleAddToCart(plan)">
            <span v-if="plan.data === '20GB'" class="popular-label">Meest populair</span>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <p>Controleer je bundel voor Saoedi-Arabië en vul je gegevens voor levering en veilige betaling in.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>Uitleg over de eSIM voor Saoedi-Arabië</span>
          <h2>Wat is een eSIM voor Saoedi-Arabië?</h2>
          <p>Een eSIM voor Saoedi-Arabië is een digitale simkaart voor mobiele data in Saoedi-Arabië, zonder een fysieke simkaart te plaatsen of op te halen.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>Geldigheid begint bij verbinding</b><small>De bundel begint wanneer de eSIM voor het eerst verbinding maakt met een ondersteund netwerk in Saoedi-Arabië.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>Dekking in Saoedi-Arabië</b><small>Gebruik dezelfde eSIM wanneer je tussen gedekte locaties in Saoedi-Arabië reist.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Mobiele netwerken en dekking in Saoedi-Arabië</h2>
          <p>Je eSIM voor Saoedi-Arabië maakt verbinding met ondersteunde partnernetwerken, met 4G/LTE en 5G waar lokaal beschikbaar.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="Partnernetwerken in Saoedi-Arabië">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>Land</th><th>Partnernetwerk(en)</th></tr></thead>
            <tbody>
              <tr><th>🇸🇦 Saoedi-Arabië</th><td><span class="network-operators">STC<br>Mobily<br>Zain</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>Laat dataroaming ingeschakeld op de eSIM tijdens je reis in Saoedi-Arabië.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Voor wie is een eSIM voor Saoedi-Arabië geschikt?</h2>
          <p>Een eSIM voor Saoedi-Arabië is bijzonder handig voor hadj- en oemrapelgrims, maar ook voor vakanties, zakenreizen en langere verblijven.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-mosque</v-icon><div><b>Hadj in Mekka</b><p>Gebruik kaarten, officiële bedevaartsapps en berichtenapps tijdens je hele bedevaart.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-star-crescent</v-icon><div><b>Oemra in Mekka en Medina</b><p>Blijf verbonden tussen de heilige steden voor vervoer, boekingen en contact met je familie.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-airplane</v-icon><div><b>Aankomst via Jeddah</b><p>Gebruik mobiele data vanaf aankomst voor transfers, de route naar je hotel en reserveringen.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-map-marker-path</v-icon><div><b>Reizen langs meerdere steden</b><p>Gebruik één eSIM tijdens je reis tussen Mekka, Medina, Jeddah en andere bestemmingen in Saoedi-Arabië.</p></div></div>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activeer op je bestemming</b><p>Schakel na aankomst in Saoedi-Arabië SafarSIM in, selecteer deze voor mobiele data en zet dataroaming aan.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>Werkt WhatsApp met een eSIM voor Saoedi-Arabië?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Waarom kiezen voor SafarSim voor je eSIM voor Saoedi-Arabië?</h2>
          <p>SafarSim biedt een eenvoudige digitale manier om mobiele data in Saoedi-Arabië te kopen en te gebruiken.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Online aankoop</b><p>Kies en koop je databundel voor Saoedi-Arabië online.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Dekking in Saoedi-Arabië</b><p>Gebruik dezelfde eSIM in alle gedekte gebieden in Saoedi-Arabië.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Veelgestelde vragen over de eSIM voor Saoedi-Arabië</h2>
          <p>Praktische antwoorden om je eSIM voor Saoedi-Arabië goed voor te bereiden en te gebruiken.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>Werkt de eSIM in heel Saoedi-Arabië?</span><v-icon>mdi-plus</v-icon></summary><p>Deze maakt verbinding met ondersteunde partnernetwerken waar compatibele dekking beschikbaar is in Saoedi-Arabië.</p></details>
          ...
          <details><summary><span>Werkt deze wanneer ik door Saoedi-Arabië reis?</span><v-icon>mdi-plus</v-icon></summary><p>Dezelfde eSIM blijft geïnstalleerd en selecteert automatisch een beschikbaar ondersteund netwerk.</p></details>
          <details><summary><span>Kan ik de eSIM voor Saoedi-Arabië opwaarderen?</span><v-icon>mdi-plus</v-icon></summary><p>Of opwaarderen mogelijk is, hangt af van de gekozen bundel. Koop een nieuwe bundel als opwaarderen niet beschikbaar is.</p></details>
    ...
    <section class="europe-related-section">
      <v-container class="europe-related-container">
        ...
        <div class="europe-related-grid">
          <router-link to="/nl/esim/turkiye" class="europe-related-card"><img :src="getFlagImage('TR')" alt="Turkije"><strong>eSIM Turkije</strong><v-icon>mdi-arrow-right</v-icon></router-link>
...
import saudiArabiaHeroImage from '@/assets/images/hero_saudi_arabia.png'

export default {
  name: 'SaudiArabiaDutchPage',
  ...
  methods: {
    ...
    loadRegion() {
      this.region = destinations.find((item) => item.slug === 'arabie-saoudite') || null
    },
    ...
    handleAddToCart(plan) {
      ...
      if (this.region.slug === 'arabie-saoudite') {
    ...
    updateStructuredData() {
      const locale = 'nl'
      const path = `${this.localePrefix}/esim/saudi-arabia`
      ...
      document.title = destinationTitle("Saoedi-Arabië", "nl")
    },
  },
  ...
  mounted() {
    ...
    this.restoreMetadata = applyPageMetadata({
      title: destinationTitle("Saoedi-Arabië", "nl"),
