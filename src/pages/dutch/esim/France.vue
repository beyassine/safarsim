  ...
  <div class="europe-page" dir="ltr">
      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>Blijf verbonden in heel</span><em>Frankrijk</em></h1>
            <p class="europe-hero-description">Reis door Frankrijk met één prepaid eSIM. Blijf verbonden in Parijs, Lyon, Marseille en daarbuiten zonder je fysieke simkaart te vervangen.</p>
          ...
          <div class="europe-visual" style="--hero-bottom-trim: 0.84635%">
            <div class="europe-map-card">
              <img :src="franceHeroImage" alt="Bezienswaardigheden in Frankrijk met eSIM-verbinding">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section class="destination-benefits-strip">
      <v-container class="destination-proof-grid">
        ...
        <div class="destination-proof-item"><v-icon size="26" aria-hidden="true">mdi-signal</v-icon><b>Lokale netwerken</b></div>
      </v-container>
    </section>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <h2>Kies je eSIM-bundel voor Frankrijk</h2>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <p>Controleer je bundel voor Frankrijk en vul je gegevens voor levering en veilige betaling in.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>Uitleg over de eSIM voor Frankrijk</span>
          <h2>Wat is een eSIM voor Frankrijk?</h2>
          <p>Een eSIM voor Frankrijk is een digitale simkaart voor mobiele data in Frankrijk, zonder een fysieke simkaart te plaatsen of op te halen.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>Geldigheid begint bij verbinding</b><small>De bundel begint wanneer de eSIM voor het eerst verbinding maakt met een ondersteund netwerk in Frankrijk.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>Dekking in Frankrijk</b><small>Gebruik dezelfde eSIM wanneer je tussen gedekte locaties in Frankrijk reist.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Mobiele netwerken en dekking in Frankrijk</h2>
          <p>Je eSIM voor Frankrijk maakt verbinding met ondersteunde partnernetwerken, met 4G/LTE en 5G waar lokaal beschikbaar.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="Partnernetwerken in Frankrijk">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>Land</th><th>Partnernetwerk(en)</th></tr></thead>
            <tbody>
              <tr><th>🇫🇷 Frankrijk</th><td><span class="network-operators">Orange (France)<br>Bouygues Télécom<br>Free Mobile Iliad</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>Laat dataroaming ingeschakeld op de eSIM tijdens je reis in Frankrijk.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Voor wie is een eSIM voor Frankrijk geschikt?</h2>
          <p>Een eSIM voor Frankrijk is handig voor vakanties, stedentrips, zakenreizen en langere verblijven in Frankrijk.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>Stedentrip naar Parijs of Lyon</b><p>Gebruik kaarten, berichtenapps en boekingsapps tijdens je hele verblijf.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-beach</v-icon><div><b>Middellandse Zeekust</b><p>Blijf verbonden tijdens je bezoek aan Marseille, Nice of nabijgelegen bestemmingen.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-image-filter-hdr</v-icon><div><b>Provence en Zuid-Frankrijk</b><p>Houd mobiele data beschikbaar voor vervoer en reserveringen.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-map-marker-path</v-icon><div><b>Reizen langs meerdere steden</b><p>Gebruik één eSIM tijdens je reis tussen Franse steden.</p></div></div>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activeer op je bestemming</b><p>Schakel na aankomst in Frankrijk SafarSIM in, selecteer deze voor mobiele data en zet dataroaming aan.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>Werkt WhatsApp met een eSIM voor Frankrijk?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Waarom kiezen voor SafarSim voor je eSIM voor Frankrijk?</h2>
          <p>SafarSim biedt een eenvoudige digitale manier om mobiele data in Frankrijk te kopen en te gebruiken.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Online aankoop</b><p>Kies en koop je databundel voor Frankrijk online.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Dekking in Frankrijk</b><p>Gebruik dezelfde eSIM in alle gedekte gebieden in Frankrijk.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Veelgestelde vragen over de eSIM voor Frankrijk</h2>
          <p>Praktische antwoorden om je eSIM voor Frankrijk goed voor te bereiden en te gebruiken.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>Werkt de eSIM in heel Frankrijk?</span><v-icon>mdi-plus</v-icon></summary><p>Deze maakt verbinding met ondersteunde partnernetwerken waar compatibele dekking beschikbaar is in Frankrijk.</p></details>
          ...
          <details><summary><span>Werkt deze wanneer ik door Frankrijk reis?</span><v-icon>mdi-plus</v-icon></summary><p>Dezelfde eSIM blijft geïnstalleerd en selecteert automatisch een beschikbaar ondersteund netwerk.</p></details>
          <details><summary><span>Kan ik de eSIM voor Frankrijk opwaarderen?</span><v-icon>mdi-plus</v-icon></summary><p>Of opwaarderen mogelijk is, hangt af van de gekozen bundel. Koop een nieuwe bundel als opwaarderen niet beschikbaar is.</p></details>
...
import franceHeroImage from '@/assets/images/hero_france.png'

export default {
  name: 'FranceDutchPage',
  ...
  methods: {
    ...
    loadRegion() {
      this.region = destinations.find((item) => item.slug === 'france') || null
    },
    ...
    updateStructuredData() {
      const locale = 'nl'
      const path = `${this.localePrefix}/esim/france`
      ...
      document.title = destinationTitle("Frankrijk", "nl")
    },
  },
  ...
  mounted() {
    ...
    this.restoreMetadata = applyPageMetadata({
      title: destinationTitle("Frankrijk", "nl"),
