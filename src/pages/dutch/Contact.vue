  ...
  <div class="legal-page">
    <v-container class="py-12 py-md-16">
      <div class="text-center mb-8">
        ...
        <p class="page-subtitle"> Ons team helpt je vóór, tijdens en na je aankoop. </p>
      </div>
        ...
        <v-col cols="12" md="8" lg="7">
          <v-card class="content-card" elevation="0">
            <div class="contact-block">
              ...
              <p> Voor vragen over je bestelling, je eSIM of de installatie kun je rechtstreeks contact met ons opnemen: </p>
            ...
            <div class="contact-block">
              <h2>Reactietijden</h2>
              <p> We doen ons best om zo snel mogelijk te reageren, meestal binnen 2 werkdagen. </p>
            </div>

            <div class="contact-block">
              <h2>Ondersteuning</h2>
              <p> Neem contact met ons op voordat je een terugbetaling aanvraagt, zodat we het probleem snel kunnen onderzoeken en oplossen. </p>
            </div>
