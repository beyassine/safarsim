    ...
    <v-container class="py-12 py-md-16">
      <div class="text-center mb-10">
        ...
        <p class="page-subtitle">
          Des forfaits simples, flexibles et adaptés à vos voyages, avec des prix transparents selon chaque destination.
        </p>
      </div>
      ...
      <v-card class="pricing-card mb-10" elevation="0">
        <div class="pricing-header">
          ...
          <p>
            Les tarifs varient selon la destination, la quantité de données et la durée du forfait. Vous trouverez sur SafarSim des offres adaptées aux courts séjours comme aux voyages plus longs.
          </p>
        </div>
            ...
            <div class="destination-content" :class="{ 'destination-content--rtl': false }">
              <div class="destination-top">
                ...
                <div class="from-price" :class="{ 'from-price--rtl': false }">
                  <span class="from-price-label">À partir de</span>
                  <span class="from-price-value" dir="ltr">{{ formatPriceFromMad(getEntryPrice(destination), 'fr') }}</span>
                </div>
              </div>
              ...
              <div class="plans-preview">
                ...
                >
                  ...
                  <span class="plan-value">{{ formatPriceFromMad(plan.price, 'fr') }}</span>
                </div>
              </div>
...
function formatPlanLabel(key) {
  ...
  return data + " / " + duration.replace("days", "jours")
}
...
function getDestinationName(destination) {
  return getLocalizedName(destination, 'fr')
}
