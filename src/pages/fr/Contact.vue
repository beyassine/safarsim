        ...
        <v-col cols="12" md="8" lg="7">
          <v-card class="content-card" elevation="0">
            <div class="contact-block">
              ...
              <p>
                Pour toute question sur votre commande, votre eSIM ou votre installation, vous pouvez nous contacter directement :
              </p>
            ...
            <div class="contact-block">
              ...
              <p>
                Nous faisons de notre mieux pour répondre dans les plus brefs délais, généralement sous 2 jours ouvrables.
              </p>
            </div>
            ...
            <div class="contact-block">
              <h2>Assistance</h2>
              <p>
                Avant de demander un remboursement, nous vous invitons à nous contacter afin que nous puissions vérifier et résoudre rapidement le problème.
              </p>
            </div>
