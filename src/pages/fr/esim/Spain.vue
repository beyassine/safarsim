      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            ...
            <p>Voyagez partout en Espagne avec une seule eSIM prépayée. Restez connecté à Madrid, Barcelone, Séville et ailleurs sans changer votre carte SIM physique.</p>
    ...
    <section class="europe-comparison-section">
      <v-container class="europe-comparison-container">
        <div class="europe-section-heading compact">
          ...
          <h2>eSIM Espagne ou itinérance internationale ?</h2>
          <p>Comparez une eSIM Espagne prépayée avec l’itinérance internationale de votre opérateur.</p>
        </div>
        <div class="comparison-table-wrap">
          <table class="comparison-table">
            <thead>
              <tr><th></th><th>eSIM Espagne</th><th>Roaming international</th></tr>
            </thead>
            <tbody>
        ...
        <div class="comparison-recommendation">
          ...
          <p>Choisissez une eSIM Espagne pour disposer de données prépayées avec un volume connu avant le départ. Consultez les conditions de roaming de votre opérateur avant de comparer les coûts.</p>
        </div>
