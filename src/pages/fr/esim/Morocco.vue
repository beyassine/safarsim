<template>
  <div class="europe-page" dir="ltr">
      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>Restez connecté partout au</span><em>Maroc</em></h1>
            <p class="europe-hero-description">Voyagez partout au Maroc avec une seule eSIM prépayée. Restez connecté à Marrakech, Casablanca, Rabat et ailleurs sans changer votre carte SIM physique.</p>
            <div class="europe-actions">
              <v-btn color="#d91c58" rounded="pill" size="x-large" elevation="0" class="europe-primary" @click="scrollEuropePlans">
                Voir les forfaits Maroc<v-icon end>mdi-arrow-down</v-icon>
              </v-btn>
            </div>
          ...
          <div class="europe-visual" style="--hero-bottom-trim: 0%">
            <div class="europe-map-card" style="aspect-ratio: 8 / 5; overflow: hidden; display: block; margin-bottom: 0">
              <img width="1536" height="1024" fetchpriority="high" :src="moroccoHeroImage" alt="Monuments du Maroc et connexion eSIM">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <p>Vérifiez votre forfait Maroc, puis renseignez la livraison et le paiement sécurisé.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>L’eSIM Maroc expliquée</span>
          <h2>Qu’est-ce qu’une eSIM Maroc ?</h2>
          <p>Une eSIM Maroc est une carte SIM numérique permettant d’utiliser les données mobiles au Maroc sans insérer ni récupérer de carte SIM physique.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>Validité dès la connexion</b><small>Le forfait démarre lors de la première connexion à un réseau pris en charge au Maroc.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>Couverture au Maroc</b><small>Utilisez la même eSIM pendant vos déplacements dans les zones couvertes du pays.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Réseaux mobiles et couverture au Maroc</h2>
          <p>Votre eSIM Maroc se connecte aux opérateurs partenaires pris en charge, en 4G/LTE selon la couverture locale.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="Réseaux partenaires au Maroc">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>Pays</th><th>Réseau(x) partenaire(s)</th></tr></thead>
            <tbody>
              <tr><th>🇲🇦 Maroc</th><td><span class="network-operators">Orange Maroc<br>Maroc Telecom</span><span class="technology-badge">4G / LTE</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>Gardez l’itinérance des données activée sur l’eSIM pendant vos déplacements au Maroc.</span>
        </div>
        <p class="network-disclaimer">La disponibilité du réseau et le débit dépendent de la couverture locale, des conditions du réseau et de la compatibilité de votre appareil.</p>
      </v-container>
    </section>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Pour quels voyages choisir une eSIM Maroc ?</h2>
          <p>Une eSIM Maroc convient aux vacances, séjours urbains, voyages d’affaires et circuits à travers le pays.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>Séjour à Marrakech</b><p>Utilisez cartes, messagerie et réservations pendant votre séjour.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-beach</v-icon><div><b>Côte atlantique</b><p>Restez connecté à Agadir, Essaouira et dans les destinations voisines.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-image-filter-hdr</v-icon><div><b>Fès et les villes impériales</b><p>Gardez vos données pour les transports et réservations.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-map-marker-path</v-icon><div><b>Circuit multi-villes</b><p>Utilisez une seule eSIM entre plusieurs villes marocaines.</p></div></div>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activez-la à destination</b><p>À votre arrivée au Maroc, activez SafarSIM, choisissez-la pour les données mobiles et activez l’itinérance.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>WhatsApp fonctionne-t-il avec une eSIM Maroc ?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Pourquoi choisir SafarSim pour votre eSIM Maroc ?</h2>
          <p>SafarSim propose une solution numérique simple pour acheter et utiliser des données mobiles au Maroc.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Achat en ligne</b><p>Choisissez et achetez votre forfait data Maroc en ligne.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Couverture au Maroc</b><p>Utilisez la même eSIM dans les zones couvertes au Maroc.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>FAQ sur l’eSIM Maroc</h2>
          <p>Des réponses pratiques pour préparer et utiliser correctement votre eSIM Maroc.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>L’eSIM fonctionne-t-elle partout au Maroc ?</span><v-icon>mdi-plus</v-icon></summary><p>Elle se connecte aux réseaux partenaires pris en charge lorsque la couverture compatible est disponible au Maroc.</p></details>
          ...
          <details><summary><span>Quelle technologie mobile est prise en charge ?</span><v-icon>mdi-plus</v-icon></summary><p>Les forfaits Maroc prennent en charge la 4G/LTE sur les réseaux partenaires compatibles. La disponibilité et le débit dépendent de votre position et de votre appareil.</p></details>
          ...
          <details><summary><span>Fonctionne-t-elle pendant mes déplacements au Maroc ?</span><v-icon>mdi-plus</v-icon></summary><p>La même eSIM reste installée et sélectionne automatiquement un réseau compatible disponible.</p></details>
          <details><summary><span>Puis-je recharger mon eSIM Maroc ?</span><v-icon>mdi-plus</v-icon></summary><p>La recharge dépend du forfait sélectionné. Si elle n’est pas proposée, achetez un nouveau forfait.</p></details>
    ...
    <div class="europe-last-updated">
      <v-container><v-icon size="17">mdi-calendar-check-outline</v-icon><span>Informations mises à jour le 11 septembre 2026.</span></v-container>
    </div>
      ...
      const schema = [
        ...
        },
        {
          ...
          offers: this.sortedPlans.map((plan) => ({
            '@type': 'Offer', name: `${plan.dataLabel} · ${plan.days} jours`,
...
.morocco-policy-section{padding:90px 0;background:#f7f4f1}.morocco-policy-container{max-width:950px}.morocco-policy-copy{display:grid;gap:14px;padding:26px 28px;border:1px solid #efdce3;border-radius:22px;background:#fff;color:#526b65;box-shadow:0 12px 30px rgba(96,45,65,.05)}.morocco-policy-copy p{margin:0;font-size:15px;line-height:1.8}.morocco-policy-copy strong{color:var(--eu-green)}@media(max-width:600px){.morocco-policy-section{padding:65px 0}.morocco-policy-copy{padding:21px 19px}.morocco-policy-copy p{font-size:14px}}
