      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>Restez connecté<br>pendant le Hajj et la Omra en</span><em>Arabie saoudite</em></h1>
            <p class="europe-hero-description">Préparez votre voyage pour le Hajj ou la Omra avec une eSIM prépayée. Restez connecté à La Mecque, Médine, Djeddah et dans tout le Royaume sans changer de carte SIM.</p>
