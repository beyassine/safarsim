      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            <h1><span>Restez connecté pendant le Hajj et la Omra en</span><em>Arabie saoudite</em></h1>
            <p>Préparez votre voyage pour le Hajj ou la Omra avec une eSIM prépayée. Restez connecté à La Mecque, Médine, Djeddah et dans tout le Royaume sans changer de carte SIM.</p>
            <div class="europe-actions">
              <v-btn color="#d91c58" rounded="pill" size="x-large" elevation="0" class="europe-primary" @click="scrollEuropePlans">
                Voir les forfaits Arabie saoudite<v-icon end>mdi-arrow-down</v-icon>
              </v-btn>
            </div>
          </div>
          <div class="europe-visual" style="--hero-bottom-trim: 3.25521%">
            <div class="europe-map-card">
              <img :src="saudiArabiaHeroImage" alt="Arabie saoudite landmarks with eSIM connectivity">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <p>Vérifiez votre forfait Arabie saoudite, puis renseignez la livraison et le paiement sécurisé.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>L’eSIM Arabie saoudite expliquée</span>
          <h2>Qu’est-ce qu’une eSIM Arabie saoudite ?</h2>
          <p>Une eSIM Arabie saoudite est une carte SIM numérique permettant d’utiliser les données mobiles en Arabie saoudite sans insérer ni récupérer de carte SIM physique.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>Validité dès la connexion</b><small>Le forfait démarre lors de la première connexion à un réseau pris en charge en Arabie saoudite.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>Couverture en Arabie saoudite</b><small>Utilisez la même eSIM pendant vos déplacements dans les zones couvertes du pays.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Réseaux mobiles et couverture en Arabie saoudite</h2>
          <p>Votre eSIM Arabie saoudite se connecte aux opérateurs partenaires pris en charge, en 4G/LTE et en 5G lorsque celle-ci est disponible localement.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="Réseaux partenaires en Arabie saoudite">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>Pays</th><th>Réseau(x) partenaire(s)</th></tr></thead>
            <tbody>
              <tr><th>🇸🇦 Arabie saoudite</th><td><span class="network-operators">STC<br>Mobily<br>Zain</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>Gardez l’itinérance des données activée sur l’eSIM pendant vos déplacements en Arabie saoudite.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Pour quels voyages choisir une eSIM Arabie saoudite ?</h2>
          <p>Une eSIM Arabie saoudite convient particulièrement aux pèlerins du Hajj et de la Omra, ainsi qu’aux vacances et voyages d’affaires.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-mosque</v-icon><div><b>Hajj à La Mecque</b><p>Utilisez les cartes, applications officielles et la messagerie durant votre pèlerinage.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-star-crescent</v-icon><div><b>Omra à La Mecque et Médine</b><p>Restez connecté entre les villes saintes pour les transports, réservations et contacts.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-airplane</v-icon><div><b>Arrivée par Djeddah</b><p>Accédez à Internet dès l’arrivée pour vos transferts, hôtels et réservations.</p></div></div>
    ...
    <section class="europe-comparison-section">
      <v-container class="europe-comparison-container">
        <div class="europe-section-heading compact">
          ...
          <h2>eSIM Arabie saoudite ou itinérance internationale ?</h2>
          <p>Comparez une eSIM Arabie saoudite prépayée avec l’itinérance internationale de votre opérateur.</p>
        </div>
        <div class="comparison-table-wrap">
          <table class="comparison-table">
            <thead>
              <tr><th></th><th>eSIM Arabie saoudite</th><th>Roaming international</th></tr>
            </thead>
            <tbody>
        ...
        <div class="comparison-recommendation">
          ...
          <p>Choisissez une eSIM Arabie saoudite pour disposer de données prépayées avec un volume connu avant le départ. Consultez les conditions de roaming de votre opérateur avant de comparer les coûts.</p>
        </div>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activez-la à destination</b><p>À votre arrivée en Arabie saoudite, activez SafarSIM, choisissez-la pour les données mobiles et activez l’itinérance.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>WhatsApp fonctionne-t-il avec une eSIM Arabie saoudite ?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Pourquoi choisir SafarSim pour votre eSIM Arabie saoudite ?</h2>
          <p>SafarSim propose une solution numérique simple pour acheter et utiliser des données mobiles en Arabie saoudite.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Achat en ligne</b><p>Choisissez et achetez votre forfait data Arabie saoudite en ligne.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Couverture en Arabie saoudite</b><p>Utilisez la même eSIM dans les zones couvertes en Arabie saoudite.</p></div></div>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>FAQ sur l’eSIM Arabie saoudite</h2>
          <p>Des réponses pratiques pour préparer et utiliser correctement votre eSIM Arabie saoudite.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>L’eSIM fonctionne-t-elle partout en Arabie saoudite ?</span><v-icon>mdi-plus</v-icon></summary><p>Elle se connecte aux réseaux partenaires pris en charge lorsque la couverture compatible est disponible en Arabie saoudite.</p></details>
          ...
          <details><summary><span>Fonctionne-t-elle pendant mes déplacements en Arabie saoudite ?</span><v-icon>mdi-plus</v-icon></summary><p>La même eSIM reste installée et sélectionne automatiquement un réseau compatible disponible.</p></details>
          <details><summary><span>Puis-je recharger mon eSIM Arabie saoudite ?</span><v-icon>mdi-plus</v-icon></summary><p>La recharge dépend du forfait sélectionné. Si elle n’est pas proposée, achetez un nouveau forfait.</p></details>
