        ...
        <div class="europe-hero-grid">
          ...
          <div class="europe-visual" style="--hero-bottom-trim: 4.75260%">
            <div class="europe-map-card">
              <img :src="turkeyHeroImage" alt="Turquie landmarks with eSIM connectivity">
            </div>
          </div>
        </div>
      </v-container>
    ...
    <section id="europe-plans" class="europe-plans-section">
      <v-container>
        <div class="europe-section-heading">
          ...
          <h2>Choisissez votre forfait eSIM Turquie</h2>
    ...
    <section v-if="checkoutOpen" id="europe-checkout" class="europe-checkout-section">
      <v-container>
        <div class="europe-section-heading europe-checkout-heading">
          ...
          <p>Vérifiez votre forfait Turquie, puis renseignez la livraison et le paiement sécurisé.</p>
        </div>
    ...
    <section class="europe-explainer-section">
      <v-container class="europe-explainer-container">
        <div class="europe-explainer-copy">
          <span>L’eSIM Turquie expliquée</span>
          <h2>Qu’est-ce qu’une eSIM Turquie ?</h2>
          <p>Une eSIM Turquie est une carte SIM numérique permettant d’utiliser les données mobiles en Turquie sans insérer ni récupérer de carte SIM physique.</p>
        </div>
        <div class="europe-facts-grid">
          ...
          <div class="europe-fact"><v-icon>mdi-timer-outline</v-icon><span><b>Validité dès la connexion</b><small>Le forfait démarre lors de la première connexion à un réseau pris en charge en Turquie.</small></span></div>
          <div class="europe-fact"><v-icon>mdi-map-marker-radius</v-icon><span><b>Couverture en Turquie</b><small>Utilisez la même eSIM pendant vos déplacements dans les zones couvertes du pays.</small></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-network-section">
      <v-container class="europe-network-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Réseaux mobiles et couverture en Turquie</h2>
          <p>Votre eSIM Turquie se connecte aux opérateurs partenaires pris en charge, en 4G/LTE et en 5G lorsque celle-ci est disponible localement.</p>
        </div>
        <div class="network-disclosure" role="group" aria-label="Réseaux partenaires en Turquie">
        <div class="network-table-wrap">
          <table class="network-table">
            <thead><tr><th>Pays</th><th>Réseau(x) partenaire(s)</th></tr></thead>
            <tbody>
              <tr><th>🇹🇷 Turquie</th><td><span class="network-operators">AVEA .Iletisim Hizmetleri A.S<br>Turkcell Iletisim Hizmetleri A.S.</span><span class="technology-badge">4G / 5G</span></td></tr>
            </tbody>
          </table>
        </div>
        </div>
        <div class="network-notes network-notes-after-table">
          ...
          <span><v-icon size="20">mdi-earth-arrow-right</v-icon>Gardez l’itinérance des données activée sur l’eSIM pendant vos déplacements en Turquie.</span>
        </div>
    ...
    <section class="europe-use-cases-section">
      <v-container class="europe-use-cases-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Pour quels voyages choisir une eSIM Turquie ?</h2>
          <p>Une eSIM Turquie convient aux vacances, séjours urbains, voyages d’affaires et circuits à travers le pays.</p>
        </div>
        <div class="europe-use-cases-grid">
          <div class="europe-use-case-card"><v-icon>mdi-city-variant-outline</v-icon><div><b>Séjour à Istanbul</b><p>Utilisez cartes, messagerie et réservations pendant votre séjour.</p></div></div>
          <div class="europe-use-case-card"><v-icon>mdi-beach</v-icon><div><b>Côte méditerranéenne</b><p>Restez connecté à Antalya, Bodrum et dans les destinations voisines.</p></div></div>
    ...
    <section class="europe-activation-section">
      <v-container class="europe-activation-container">
        ...
        <div class="activation-guidance">
          ...
          <div><v-icon>mdi-airplane-landing</v-icon><span><b>Activez-la à destination</b><p>À votre arrivée en Turquie, activez SafarSIM, choisissez-la pour les données mobiles et activez l’itinérance.</p></span></div>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-whatsapp-section">
      <v-container class="europe-whatsapp-container">
        <div class="whatsapp-title-row">
          ...
          <h2>WhatsApp fonctionne-t-il avec une eSIM Turquie ?</h2>
        </div>
    ...
    <section class="europe-why-safarsim-section">
      <v-container class="europe-why-safarsim-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Pourquoi choisir SafarSim pour votre eSIM Turquie ?</h2>
          <p>SafarSim propose une solution numérique simple pour acheter et utiliser des données mobiles en Turquie.</p>
        </div>
        <div class="safarsim-facts-grid">
          <div class="safarsim-fact-card"><v-icon>mdi-cart-outline</v-icon><div><b>Achat en ligne</b><p>Choisissez et achetez votre forfait data Turquie en ligne.</p></div></div>
          ...
          <div class="safarsim-fact-card"><v-icon>mdi-earth</v-icon><div><b>Couverture en Turquie</b><p>Utilisez la même eSIM dans les zones couvertes en Turquie.</p></div></div>
    ...
    <section class="turkey-policy-section">
      <v-container class="turkey-policy-container">
        <div class="europe-section-heading compact">
          ...
          <h2>Restrictions eSIM en Turquie : comment préparer votre voyage ?</h2>
          <p>La Turquie n’interdit pas la technologie eSIM. Les restrictions concernent notamment l’accès, depuis certains réseaux turcs, aux sites et applications de plusieurs fournisseurs internationaux d’eSIM.</p>
        </div>
        <div class="turkey-policy-copy">
          <p>Achetez et installez votre eSIM SafarSim avant votre départ, depuis l’Europe ou votre pays de résidence. Enregistrez également le QR code et les instructions d’installation sur votre téléphone afin de pouvoir les consulter hors ligne.</p>
          <p>Une fois en Turquie, sélectionnez SafarSim pour les données mobiles et activez l’itinérance des données. Une eSIM déjà installée peut se connecter aux réseaux partenaires disponibles sans nécessiter l’accès au site du fournisseur.</p>
          <p><strong>SafarSim a été testée depuis l’Europe et fonctionne correctement pour les voyages en Turquie lorsqu’elle est achetée et installée avant le départ.</strong> La disponibilité du réseau reste toutefois soumise à la couverture locale, à la compatibilité du téléphone et aux conditions du réseau.</p>
        </div>
      </v-container>
    </section>
    ...
    <section class="europe-faq-section">
      <v-container class="europe-faq-container">
        <div class="europe-section-heading compact">
          ...
          <h2>FAQ sur l’eSIM Turquie</h2>
          <p>Des réponses pratiques pour préparer et utiliser correctement votre eSIM Turquie.</p>
        </div>
        <div class="europe-faq-list">
          <details><summary><span>L’eSIM fonctionne-t-elle partout en Turquie ?</span><v-icon>mdi-plus</v-icon></summary><p>Elle se connecte aux réseaux partenaires pris en charge lorsque la couverture compatible est disponible en Turquie.</p></details>
          ...
          <details><summary><span>Fonctionne-t-elle pendant mes déplacements en Turquie ?</span><v-icon>mdi-plus</v-icon></summary><p>La même eSIM reste installée et sélectionne automatiquement un réseau compatible disponible.</p></details>
          <details><summary><span>Puis-je recharger mon eSIM Turquie ?</span><v-icon>mdi-plus</v-icon></summary><p>La recharge dépend du forfait sélectionné. Si elle n’est pas proposée, achetez un nouveau forfait.</p></details>
...
export default {
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = destinationTitle("Turquie", "fr")
    },
  },
  ...
  mounted() {
    ...
    this.restoreMetadata = applyPageMetadata({
      title: destinationTitle("Turquie", "fr"),
