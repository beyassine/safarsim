  ...
  <div class="europe-page" dir="ltr">
      ...
      <v-container class="europe-hero-inner">
        ...
        <div class="europe-hero-grid">
          <div class="europe-hero-copy">
            ...
            <p class="europe-hero-description">Voyagez partout en France avec une seule eSIM prépayée. Restez connecté à Paris, Lyon, Marseille et ailleurs sans changer votre carte SIM physique.</p>
    ...
    <section class="destination-benefits-strip">
      <v-container class="destination-proof-grid">
        ...
        <div class="destination-proof-item"><v-icon size="26" aria-hidden="true">mdi-signal</v-icon><b>Réseaux locaux</b></div>
      </v-container>
    </section>
...
export default {
  ...
  methods: {
    ...
    updateStructuredData() {
      ...
      document.title = destinationTitle("France", "fr")
    },
  },
  ...
  mounted() {
    ...
    this.restoreMetadata = applyPageMetadata({
      title: destinationTitle("France", "fr"),
