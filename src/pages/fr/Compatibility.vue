    ...
    <v-container class="py-8 py-md-12" style="max-width: 980px">
      ...
      >
        <router-link to="/" class="text-decoration-none">
          <span class="text-medium-emphasis">Accueil</span>
        </router-link>
      ...
      <div class="mb-8">
        ...
        <v-card rounded="xl" elevation="1" class="pa-5 compatibility-card mb-8">
          <h4 class="subsection-title mb-4 bidi-text">Compatibilité téléphone</h4>
          <v-alert
          ...
          >
            <span>
              {{ hasSelectedCompatiblePhone
                ? "Votre téléphone est compatible avec la eSIM."
                : "Merci de sélectionner le modèle de votre téléphone. Votre téléphone doit être d’une génération récente pour adopter la eSIM." }}
            </span>
          </v-alert>
        ...
        <v-alert class="mt-10 pa-6 text-center" variant="tonal" rounded="lg" >
          ...
          <p class="mb-4 bidi-text">
            Il ne vous reste plus qu’à choisir votre destination et profiter d’une connexion internet immédiate avec eSIM <strong class="text-pink-darken-1 font-weight-bold"><bdi dir="ltr">SAFAR SIM</bdi></strong>.
          </p>
